...
class Sukarelawan extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sukan','nama', 'no_kad_pengenalan', 'alamat_1', 'alamat_negeri', 'alamat_poskod', 
                'tarikh_lahir', 'jantina', 'no_tel_bimbit', 'status', 'kebatasan_fizikal', 'kelulusan_akademi', 
                'bidang_kepakaran', 'pekerjaan_semasa', 'alamat_majikan_1', 'alamat_majikan_negeri', 'alamat_majikan_poskod', 'bidang_diminati', 'waktu_ketika_diperlukan', 
            ...
            [['nama', 'menyatakan_jika_ada_kebatasan_fizikal', 'kelulusan_akademi','pekerjaan_semasa', 'nama_majikan', 'bidang_diminati', 'waktu_ketika_diperlukan', 
                ...
                'status', 'alamat_majikan_negeri', 'saiz_baju','alamat_bandar', 'alamat_majikan_bandar','emel', 'facebook', 'bidang_diminati_lain_lain',
