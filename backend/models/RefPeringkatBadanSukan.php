...
/**
 * This is the model class for table "tbl_ref_peringkat_badan_sukan".
 *
 * @property integer $id
 ...
 */
class RefPeringkatBadanSukan extends \yii\db\ActiveRecord
{
    const KEBANGSAAN = 1;
    const NEGERI = 2;
    const DAERAH = 3;
    ...
    {
        return 'tbl_ref_peringkat_badan_sukan';
    }
