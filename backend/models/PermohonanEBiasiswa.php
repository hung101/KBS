...
class PermohonanEBiasiswa extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nama', 'no_kad_pengenalan', 'tarikh_lahir', 'jantina', 'keturunan', 'agama', 'taraf_perkahwinan', 'kawasan_temuduga_anda', 'alamat_1', 'alamat_negeri', 'alamat_bandar', 'alamat_poskod', 'no_tel_bimbit', 'universiti_institusi', 'program_pengajian', 'kursus_bidang_pengajian', 'falkulti', 'kategori', 'tarikh_mula', 'tarikh_tamat', 'semester_terkini', 'baki_semester_yang_tinggal', 'no_matriks', 'sukan', 'perakuan_pemohon', 'status_permohonan'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required],
            [['tarikh_tamat', 'tarikh_temuduga', 'tarikh_lahir', 'tarikh_permohonan'], 'safe'],
            [['semester_terkini', 'baki_semester_yang_tinggal', 'perakuan_pemohon', 'kelulusan', 'mendapat_pembiayaan_pendidikan_bool', 'contoh', 'admin_e_biasiswa_id'], 'integer', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_integer],
            ...
            [['nama', 'oku_lain_lain', 'universiti_institusi', 'program_pengajian', 'kursus_bidang_pengajian', 'falkulti', 'sukan', 'nyatakan_nama_penaja','keturunan',
                'agama', 'taraf_perkahwinan','kawasan_temuduga_anda', 'alamat_1', 'alamat_2', 'alamat_3', 'alamat_negeri', 'no_pendaftaran_oku', 'kategori_oku', 'kategori', 
                'no_matriks', 'mendapat_pembiayaan_pendidikan', 'status_permohonan','alamat_bandar','tempat_temuduga','oku_lain_lain'], 'filter', 'filter' => function ($value) {
