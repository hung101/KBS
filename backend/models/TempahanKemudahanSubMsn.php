    ...
    public function rules()
    {
        return [
            ...
            [['lelaki', 'wanita', 'melayu', 'cina', 'india', 'lain_lain', 'jumlah_orang', 'kemudahan', 'jenis_kadar', 'quantity_kadar', 
                'public_user_pemohon_id', 'public_user_pemilik_id', 'kategori_hakmilik', 'no_kad_pengenalan', 'no_tel', 'jumlah_jam'], 'integer', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_integer],
            ...
            [['nama', 'venue', 'nama_pemilik','quantity_kadar','location_alamat_1', 'location_alamat_2', 'location_alamat_3','location_alamat_bandar','location_alamat_negeri',
                'email_pemilik','catatan'], function ($attribute, $params) {
