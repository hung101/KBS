...
class PermohonanEBiasiswaSearch extends PermohonanEBiasiswa
{
    ...
    {
        return [
            [['permohonan_e_biasiswa_id', 'user_public_id', 'semester_terkini', 'baki_semester_yang_tinggal', 'perakuan_pemohon', 'kelulusan'], 'integer'],
            [['muat_naik_gambar', 'nama', 'no_kad_pengenalan', 'jantina', 'keturunan', 'agama', 'taraf_perkahwinan', 'kawasan_temuduga_anda', 'alamat_1', 'alamat_2', 'alamat_3', 'alamat_negeri', 'alamat_bandar', 'alamat_poskod', 'no_tel_bimbit', 'no_pendaftaran_oku', 'kategori_oku', 'oku_lain_lain', 'universiti_institusi', 'program_pengajian', 'kursus_bidang_pengajian', 'falkulti', 'kategori', 'tarikh_tamat', 'no_matriks', 'mendapat_pembiayaan_pendidikan', 'sukan', 'status_permohonan'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'muat_naik_gambar', $this->muat_naik_gambar])
            ...
            ->andFilterWhere(['like', 'tbl_ref_status_permohonan_e_biasiswa.desc', $this->status_permohonan]);
