...
<div class="tempahan-kemudahan-form">
            ...
            'attributes' => [
                'venue' => [
                    ...
                    'options'=>[
                        ...
                        'options' => ['placeholder' => Placeholder::venue], 'disabled'=>$disabledFieldPemilik,
                        'pluginOptions' => [
                            'allowClear' => true
                        ],],
                ...
                'kemudahan' => [
                    ...
                    'options'=>[
                        ...
                        'data'=>ArrayHelper::map(PengurusanKemudahanSediaAda::find()->joinWith(['refJenisKemudahan'])->all(),'pengurusan_kemudahan_sedia_ada_id', 'refJenisKemudahan.desc'),
        ...
        echo FormGrid::widget([
            ...
            'rows' => [
                [
                    ...
                    'autoGenerateColumns'=>false, // override columns setting
                    'attributes' => [
                        'nama' =>   ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>6],'options'=>['maxlength'=>80,'disabled'=>$disabledFieldPemilik]],
                        'no_kad_pengenalan' =>['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>12,'disabled'=>$disabledFieldPemilik]],
                    ],
                ],
                [
                    'columns'=>12,
                    'autoGenerateColumns'=>false, // override columns setting
                    'attributes' => [
                        'no_tel' =>   ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>14,'disabled'=>$disabledFieldPemilik]],
                        'emel' =>['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>4],'options'=>['maxlength'=>100,'disabled'=>$disabledFieldPemilik]],
                    ],
                ],
            ]
        ]);
            ...
            'attributes' => [
                ...
                'jenis_kadar' => [
                    ...
                    'options'=>[
                        ...
                        'options' => ['placeholder' => Placeholder::jenisKadar, 'id'=>'jenisKadar','disabled'=>$disabledFieldPemilik],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],],
                    'columnOptions'=>['colspan'=>3]],
                'quantity_kadar' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>2],'options'=>['maxlength'=>11, 'id'=>'quantityKadar','disabled'=>$disabledFieldPemilik]],
    ...
    <?php
    if(\Yii::$app->user->identity->jenis_pengguna_e_kemudahan == SignupEKemudahanForm::PEMILIK || $readonly){
        echo FormGrid::widget([
            'model' => $model,
            'form' => $form,
            'autoGenerateColumns' => true,
...
$(document).ready(function(){
    ...
    var disabledFieldPemilik = '$disabledFieldPemilik';
        
    if(!readonly){
        $( "#tempahanDetails" ).hide();
    }
    
    if(disabledFieldPemilik){
        $('#kemudahanID').on('depdrop.afterChange', function(event, id, value) {
            $("#kemudahanID").prop("disabled", true);
        });
    }
}); 
...
$('#tempahankemudahan-venue').change(function(){
    ...
    $('form#{$model->formName()}').on('beforeSubmit', function (e) {
        ...
        $("#tempahankemudahan-venue").prop("disabled", false);
        $("#kemudahanID").prop("disabled", false);
        $("#jenisKadar").prop("disabled", false);
    });
