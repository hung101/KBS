...
<div class="permohonan-ebiasiswa-form">
    ...
    <div class="alert alert-success">
        <strong>Tahniah!</strong> Sukacita dimaklumkan bahawa tuan/puan telah berjaya untuk ditawarkan Biasiswa Sukan Persekutuan Kementerian Belia dan Sukan Sesi 2017. Sila muat turun borang-borang berkaitan dan muat naik semula borang yang telah lengkap. 
    ...
    ?>
        <div class="alert alert-warning">
            <strong>Perhatian - </strong> Permohonan hanya terbuka kepada atlet yang memenuhi syarat. <?php echo '&nbsp;&nbsp;' . Html::a('Muat Turun Syarat Kelayakan', 'javascript:void(0);', ['class'=>'btn btn-warning', 'onclick' => 'viewUpload("'.\Yii::$app->request->BaseUrl.'/'.$modelAdminEBiasiswa->muat_naik_syarat_kelayakan.'");']);?>
        </div>
    ...
    <?php
        if(!$readonly){
            echo Html::a('Kembali', ['site/e-biasiswa-home'], ['class' => 'btn btn-warning']);
        }
    ?>
