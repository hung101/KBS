...
insert  into `tbl_borang_penyertaan_atlet`(`borang_penyertaan_atlet_id`,`atlet_id`,`nama_program`,`tarikh_program`) values (1,2,'2','2015-10-05'),(2,3,'2','2015-10-14'),(3,2,'1','2015-08-01');
...
insert  into `tbl_mesyuarat_senarai_nama_hadir`(`senarai_nama_hadir_id`,`mesyuarat_id`,`nama`,`status`,`jawatan`,`organisasi`,`no_tel`,`emel`,`kehadiran`) values (1,1,'Mohd Ali Husim','','','','',NULL,'Ya'),(2,1,'Mohamad Husem','','','','',NULL,'Ya'),(3,1,'Othman bin Ahmad','','','','',NULL,'Tidak');
...
insert  into `tbl_pengurusan_insuran`(`pengurusan_insuran_id`,`atlet_id`,`nama_insuran`,`jumlah_tuntutan`,`tarikh_tuntutan`,`pegawai_yang_bertanggungjawab`,`catatan`) values (1,3,'AIA','8450.00','2015-10-01','Kenne',''),(2,2,'Zurich','500.00','2015-07-07','Wantennen','Masuk Wad'),(3,4,'Prudential','988.00','2015-06-29','Mohd Camel','Sakit Tangan Operation');
...
insert  into `tbl_permohonan_peralatan`(`permohonan_peralatan_id`,`cawangan`,`negeri`,`sukan`,`program`,`tarikh`,`aktiviti`,`jumlah_peralatan`,`nota_urus_setia`,`kelulusan`) values (2,'1','2','2','2','2015-09-01','Hoki',5,'',1),(3,'1','2','1','2','2015-09-16','Kem 12',6,'Testing Nota',0);
...
CREATE TABLE `tbl_ref_acara` (
  `ref_acara_id` int(11) NOT NULL AUTO_INCREMENT,
  `ref_sukan_id` int(11) NOT NULL,
  `nama_acara` varchar(80) NOT NULL,
  `aktif` tinyint(1) NOT NULL,
  PRIMARY KEY (`ref_acara_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `tbl_ref_sokongan`(`id`,`desc`,`aktif`,`created_by`,`updated_by`,`created`,`updated`) values (1,'Sokongan 1',1,NULL,NULL,'2015-10-05 12:30:04',NULL),(2,'Sokongan 2',1,NULL,NULL,'2015-10-05 12:30:06',NULL),(3,'Sokongan 3',1,NULL,NULL,'2015-10-05 12:30:09',NULL);
