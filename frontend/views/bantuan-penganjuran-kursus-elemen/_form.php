...
<div class="bantuan-penganjuran-kursus-elemen-form">
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#bantuanPenganjuranKursusElemenGrid'});
                }
          }
     });
     return false;
...
$('#bantuanpenganjurankursuselemen-kadar').on("keyup", function(){calculateJumlah();});
$('#bantuanpenganjurankursuselemen-bilangan').on("keyup", function(){calculateJumlah();});
$('#bantuanpenganjurankursuselemen-hari').on("keyup", function(){calculateJumlah();});
...
function calculateJumlah(){
    ...
    if($('#bantuanpenganjurankursuselemen-kadar').val() > 0){kadar = parseFloat($('#bantuanpenganjurankursuselemen-kadar').val());}
    if($('#bantuanpenganjurankursuselemen-bilangan').val() > 0){bilangan = parseInt($('#bantuanpenganjurankursuselemen-bilangan').val());}
    if($('#bantuanpenganjurankursuselemen-hari').val() > 0){hari = parseInt($('#bantuanpenganjurankursuselemen-hari').val());}
    
    // Jumlah formula
    jumlah = kadar * bilangan * hari;
        
    //display at fields accordingly
    $('#bantuanpenganjurankursuselemen-jumlah').val(jumlah);
}  
