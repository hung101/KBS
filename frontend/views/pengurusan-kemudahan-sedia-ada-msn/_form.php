...
<div class="pengurusan-kemudahan-sedia-ada-msn-form">
...
'pluginOptions' => [
                ...
                'sukan_rekreasi' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-sukan-rekreasi/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
...
'pluginOptions' => [
                ...
                'jenis_kemudahan' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-jenis-kemudahan/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                    ...
                    'rows' => [
                        [
                            ...
                            'attributes' => [
                                ...
                                'kadar_sewaan_sejam_siang_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                                'kadar_sewaan_sehari_siang_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                                //'kadar_sewaan_seminggu_siang_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                                //'kadar_sewaan_sebulan_siang_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                            ],
                        ],
                        [
                            'columns'=>12,
                            ...
                            'attributes' => [
                                ...
                                'kadar_sewaan_sejam_malam_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                                'kadar_sewaan_sehari_malam_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                                //'kadar_sewaan_seminggu_malam_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                                //'kadar_sewaan_sebulan_malam_cuti_umum' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>10]],
                            ],
                        ],
                    ]
                ]);
