...
<div class="elaporan-dokumen-sokongan-form">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'nama' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>6],'options'=>['maxlength'=>20]],
                'muat_nail' => ['type'=>Form::INPUT_FILE,'columnOptions'=>['colspan'=>6],'options'=>['maxlength'=>20]],
            ],
        ],
    ...
    <?= $form->field($model, 'muat_nail')->textInput(['maxlength' => 100]) ?>-->
