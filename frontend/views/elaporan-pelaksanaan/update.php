...
$this->title = GeneralLabel::updateTitle . ' ' . GeneralLabel::elaporan_pelaksanaan_program_aktiviti;
$this->params['breadcrumbs'][] = ['label' => GeneralLabel::elaporan_pelaksanaan_program_aktiviti, 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => GeneralLabel::viewTitle . ' ' . GeneralLabel::elaporan_pelaksanaan_program_aktiviti, 'url' => ['view', 'id' => $model->elaporan_pelaksaan_id]];
