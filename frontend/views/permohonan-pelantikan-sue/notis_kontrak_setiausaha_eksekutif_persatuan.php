...
$this->title = GeneralLabel::notis_kontrak_setiausaha_eksekutif_persatuan;
...
<div class="laporan-badan-sukan">
    ...
    'rows' => [
            ...
            'attributes' => [
                'persatuan' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/pengurusan-jawatankuasa-khas-sukan-malaysia/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,*/
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                'no_rujukan_fail' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>5],'options'=>['maxlength'=>30]],
            ],
        ],
        [
            'columns'=>12,
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                'tarikh_tamat_maklumbalas_notis_kontrak' => [
                    'type'=>Form::INPUT_WIDGET, 
                    'widgetClass'=> DateControl::classname(),
                    'ajaxConversion'=>false,
                    'options'=>[
