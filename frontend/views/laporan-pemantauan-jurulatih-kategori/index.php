...
$this->title = GeneralLabel::kategori_laporan_pemantauan_jurulatih;
...
<div class="pengurusan-penilaian-kategori-jurulatih-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::kategori_laporan_pemantauan_jurulatih, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
