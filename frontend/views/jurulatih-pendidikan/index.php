...
<div class="jurulatih-pendidikan-index">
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['MSN']['jurulatih']['create'])): ?>
        <p>
            <?= Html::button(GeneralLabel::createTitle . ' Pendidikan', ['value'=>Url::to(['create']),'class' => 'btn btn-success', 'onclick' => 'updateRenderAjax("'.Url::to(['create']).'", "'.GeneralVariable::tabPendidikanJurulatihID.'");']) ?>
        </p>
    <?php endif; ?>
