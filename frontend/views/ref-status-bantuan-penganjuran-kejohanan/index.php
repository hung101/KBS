...
$this->title = GeneralLabel::status_bantuan_penganjuran_kejohanan;
...
<div class="ref-status-bantuan-penganjuran-kejohanan-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::status_bantuan_penganjuran_kejohanan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
