...
$this->title = GeneralLabel::kategori_program_liputan_perubatan_sukan;
...
<div class="ref-kategori-program-liputan-perubatan-sukan-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::kategori_program_liputan_perubatan_sukan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
