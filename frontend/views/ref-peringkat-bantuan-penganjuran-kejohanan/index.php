...
$this->title = GeneralLabel::peringkat_bantuan_penganjuran_kejohanan;
...
<div class="ref-peringkat-bantuan-penganjuran-kejohanan-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::peringkat_bantuan_penganjuran_kejohanan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
