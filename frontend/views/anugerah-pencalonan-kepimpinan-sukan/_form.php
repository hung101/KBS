...
$('#anugerahpencalonankepimpinansukan-kategori').change(function(){
    checkKategori();
        clearForm();
});
...
function checkKategori(){
    ...
    if($('#anugerahpencalonankepimpinansukan-kategori').val() == '$KATEGORI_ATLET'){
        $('#atletDiv').show();
    } else if($('#anugerahpencalonankepimpinansukan-kategori').val() == '$KATEGORI_JURULATIH'){
        $('#jurulatihDiv').show();
    } else if($('#anugerahpencalonankepimpinansukan-kategori').val() == '$KATEGORI_PERSATUAN_SUKAN'){
        $('#persatuanDiv').show();
    }
}
        
$('#anugerahpencalonankepimpinansukan-atlet').change(function(){
    ...
    if($(this).val() != ''){
        $.get('$URLAtlet',{id:$(this).val()},function(data){
            ...
            if(data !== null){
                $('#anugerahpencalonankepimpinansukan-nama').attr('value',data.name_penuh);
                $('#anugerahpencalonankepimpinansukan-no_kad_pengenalan').attr('value',data.ic_no);
                $("#anugerahpencalonankepimpinansukan-no_tel_1").attr('value',data.tel_no);
                $("#anugerahpencalonankepimpinansukan-no_tel_2").attr('value',data.tel_bimbit_no_1);
...
$('#anugerahpencalonankepimpinansukan-jurulatih').change(function(){
    ...
    $.get('$URLJurulatih',{id:$(this).val()},function(data){
        ...
        if(data !== null){
            $('#anugerahpencalonankepimpinansukan-nama').attr('value',data.nama);
            $('#anugerahpencalonankepimpinansukan-no_kad_pengenalan').attr('value',data.ic_no);
            $('#anugerahpencalonankepimpinansukan-no_tel_1').attr('value',data.no_telefon);
            $('#anugerahpencalonankepimpinansukan-no_tel_2').attr('value',data.no_telefon_bimbit);
...
$('#anugerahpencalonankepimpinansukan-persatuan_sukan').change(function(){
    ...
    if($(this).val() != ''){
        $.get('$URLPersatuan',{id:$(this).val()},function(data){
            ...
            if(data !== null){
                //$('#anugerahpencalonankepimpinansukan-nama').attr('value',data.name_penuh);
                //$('#anugerahpencalonankepimpinansukan-no_kad_pengenalan').attr('value',data.ic_no);
                $("#anugerahpencalonankepimpinansukan-no_tel_1").attr('value',data.no_telefon_pejabat);
                $("#anugerahpencalonankepimpinansukan-no_tel_2").attr('value',data.no_tel_bimbit);
            }
        });
    }
});
...
function clearForm(){
    $('#anugerahpencalonankepimpinansukan-nama').attr('value','');
    $('#anugerahpencalonankepimpinansukan-no_kad_pengenalan').attr('value','');
    $("#anugerahpencalonankepimpinansukan-no_tel_1").attr('value','');
    $("#anugerahpencalonankepimpinansukan-no_tel_2").attr('value','');
