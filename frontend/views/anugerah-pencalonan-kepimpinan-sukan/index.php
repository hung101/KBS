...
/* @var $searchModel frontend\models\AnugerahPencalonanKepimpinanSukanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = GeneralLabel::anugerah_pencalonan_kepimpinan_sukan;
...
<div class="anugerah-pencalonan-lain-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle . ' ' . GeneralLabel::anugerah_pencalonan_kepimpinan_sukan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
