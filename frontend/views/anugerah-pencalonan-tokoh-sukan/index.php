...
/* @var $searchModel frontend\models\AnugerahPencalonanTokohSukanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = GeneralLabel::anugerah_pencalonan_tokoh_sukan;
...
<div class="anugerah-pencalonan-lain-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle . ' ' . GeneralLabel::anugerah_pencalonan_tokoh_sukan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
