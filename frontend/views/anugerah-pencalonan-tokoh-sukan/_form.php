...
<div class="anugerah-pencalonan-tokoh-sukan-form">
    ...
    <?= GridView::widget([
        'dataProvider' => $dataProviderAnugerahPencalonanTokohSukanJawatan,
        //'filterModel' => $searchModelAnugerahPencalonanTokohSukanJawatan,
            ...
            ['class' => 'yii\grid\ActionColumn',
                'buttons' => [
                    'delete' => function ($url, $model) {
                        ...
                        'onclick' => 'deleteRecordModalAjax("'.Url::to(['anugerah-pencalonan-tokoh-sukan-jawatan/delete', 'id' => $model->anugerah_pencalonan_lain_jawatan_id]).'", "'.GeneralMessage::confirmDelete.'", "anugerahPencalonanLainJawatanGrid");',
