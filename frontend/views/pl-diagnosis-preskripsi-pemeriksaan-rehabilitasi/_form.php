            ...
            'attributes' => [
                ...
                'rawatan_rehabilitasi' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-rawatan-rehabilitasi/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefRawatanRehabilitasi::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
                        'options' => ['placeholder' => Placeholder::rawatanRehabilitasi],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],],
                    'columnOptions'=>['colspan'=>4]],
