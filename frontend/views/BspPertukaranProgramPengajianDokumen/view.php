...
<div class="bsp-pertukaran-program-pengajian-dokumen-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->bsp_pertukaran_program_pengajian_dokumen_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->bsp_pertukaran_program_pengajian_dokumen_id], [
