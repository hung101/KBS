...
/* @var $model frontend\models\BantuanPenganjuranKejohananSirkitElemenSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="bantuan-penganjuran-kejohanan-elemen-search">
    ...
    <?= $form->field($model, 'bantuan_penganjuran_kejohanan_elemen_id') ?>
