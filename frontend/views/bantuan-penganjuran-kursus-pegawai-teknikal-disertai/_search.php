...
/* @var $model frontend\models\BantuanPenganjuranKursusPegawaiTeknikalDisertaiSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="bantuan-penganjuran-kursus-pegawai-teknikal-disertai-search">
    ...
    <?= $form->field($model, 'bantuan_penganjuran_kursus_pegawai_teknikal_disertai_id') ?>
