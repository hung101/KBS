...
/* @var $model frontend\models\BantuanPenganjuranKursusPenceramahSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="bantuan-penganjuran-kursus-penceramah-search">
    ...
    <?= $form->field($model, 'bantuan_penganjuran_kursus_penceramah_id') ?>
