...
$this->title = GeneralLabel::laporan_pengguna_dan_hasil_bagi_kombes_tahunan;
...
<div class="elaporan-pelaksanaan-report">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'tahun_1' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>4]],
                'tahun_2' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>4]],
            ]
        ],
        [
            'columns'=>12,
