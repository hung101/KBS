...
$this->title = GeneralLabel::laporan_pengguna_dan_hasil_bagi_kombes;
            ...
            'attributes' => [
                'kategori' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-kategori_hakmilik/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
