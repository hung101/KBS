...
if($model->bantuan_penganjuran_kursus_id && $model->bantuan_penganjuran_kursus_id != 0){
    $this->title = GeneralLabel::viewTitle . ' ' . GeneralLabel::laporan . ' ' . GeneralLabel::bantuan_penganjuran_kursus_bengkel_seminar;
}elseif($model->bantuan_penganjuran_kursus_pegawai_teknikal_id && $model->bantuan_penganjuran_kursus_pegawai_teknikal_id != 0){
    $this->title = GeneralLabel::viewTitle . ' ' . GeneralLabel::laporan . ' ' . GeneralLabel::bantuan_penganjuran_kursus_pegawai_teknikal;
}elseif($model->bantuan_penyertaan_pegawai_teknikal_id && $model->bantuan_penyertaan_pegawai_teknikal_id != 0){
    $this->title = GeneralLabel::viewTitle . ' ' . GeneralLabel::laporan . ' ' . GeneralLabel::bantuan_penyertaan_pegawai_teknikal;
}
