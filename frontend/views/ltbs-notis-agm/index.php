...
<div class="ltbs-notis-agm-index">
    ...
    <?php
        ...
        // Update Access
        if(isset(Yii::$app->user->identity->peranan_akses['PJS']['ltbs-notis-agm']['update'])){
            $template .= ' {update}';
        }
        
        // Delete Access
        if(isset(Yii::$app->user->identity->peranan_akses['PJS']['ltbs-notis-agm']['delete'])){
            $template .= ' {delete}';
        }
    ?>
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['PJS']['ltbs-notis-agm']['create'])): ?>
        <p>
            <?= Html::a(GeneralLabel::createTitle . ' Notis Mesyuarat Agong', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
    <?php endif; ?>
