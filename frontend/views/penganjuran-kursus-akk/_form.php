...
$("#penganjurankursusakk-tarikh_kursus_mula").change(function(){
    setDuration();
});
        
$("#penganjurankursusakk-tarikh_kursus_tamat").change(function(){
    setDuration();
});
        
function setDuration(){
    var fromDatetime = $("#penganjurankursusakk-tarikh_kursus_mula").val();
    var toDatetime = $("#penganjurankursusakk-tarikh_kursus_tamat").val();
        
    var fromDatetimeMoment = moment(fromDatetime,'YYYY-MM-DD');
    var toDatetimeMoment = moment(toDatetime,'YYYY-MM-DD');
        
    if(fromDatetime != "" && toDatetime != ""){
        $("#penganjurankursusakk-tempoh_kursus").val(getDurationBetweenDatetime(fromDatetimeMoment,toDatetimeMoment));
    }
}
