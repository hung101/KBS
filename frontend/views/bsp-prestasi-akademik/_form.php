...
<div class="bsp-prestasi-akademik-form">
    ...
    'rows' => [
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                'png' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>4],'options'=>['maxlength'=>5]],
                'pngk' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>4],'options'=>['maxlength'=>5]],
            ],
        ],
    ]
]);
    ...
    if($model->muat_naik){
        ...
        if(!$readonly){
            echo Html::a(GeneralLabel::remove, ['deleteupload', 'id'=>$model->bsp_prestasi_akademik_id, 'field'=> 'muat_naik'], 
            [
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#bspPrestasiAkademikGrid'});
                }
          }
     });
     return false;
