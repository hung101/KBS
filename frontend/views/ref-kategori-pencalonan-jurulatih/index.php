...
$this->title = GeneralLabel::kategori_pencalonan_jurulatih;
...
<div class="ref-kategori-pencalonan-jurulatih-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::kategori_pencalonan_jurulatih, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
