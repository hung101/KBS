...
<div class="bantuan-penganjuran-kejohanan-sirkit-laporan-form">
   ...
   ?>
    ...
    <?= GridView::widget([
        'dataProvider' => $dataProviderBantuanPenganjuranKejohananSirkitLaporanTuntutan,
        //'filterModel' => $searchModelBantuanPenganjuranKejohananSirkitLaporanTuntutan,
            ...
            ['class' => 'yii\grid\ActionColumn',
                'buttons' => [
                    'delete' => function ($url, $model) {
                        ...
                        'onclick' => 'deleteRecordModalAjax("'.Url::to(['bantuan-penganjuran-kejohanan-sirkit-laporan-tuntutan/delete', 'id' => $model->bantuan_penganjuran_kejohanan_laporan_tuntutan_id]).'", "'.GeneralMessage::confirmDelete.'", "bantuanPenganjuranKejohananLaporanTuntutanGrid");',
                    ...
                    'update' => function ($url, $model) {
                        ...
                        'onclick' => 'loadModalRenderAjax("'.Url::to(['bantuan-penganjuran-kejohanan-sirkit-laporan-tuntutan/update', 'id' => $model->bantuan_penganjuran_kejohanan_laporan_tuntutan_id]).'", "'.GeneralLabel::updateTitle . ' Tuntutan Baki Dua Puluh Peratus (20%) Daripada Jumlah Kelulusan (Jika Ada)");',
                        ]);
                    },
                    'view' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', 'javascript:void(0);', [
                        'title' => Yii::t('yii', 'View'),
                        'onclick' => 'loadModalRenderAjax("'.Url::to(['bantuan-penganjuran-kejohanan-sirkit-laporan-tuntutan/view', 'id' => $model->bantuan_penganjuran_kejohanan_laporan_tuntutan_id]).'", "'.GeneralLabel::viewTitle . ' Tuntutan Baki Dua Puluh Peratus (20%) Daripada Jumlah Kelulusan (Jika Ada)");',
                        ]);
                    }
                ],
                'template' => $template,
