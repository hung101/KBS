...
$this->title = GeneralLabel::jenis_perkhidmatan_akademik;
...
<div class="ref-jenis-perkhidmatan-akademik-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::jenis_perkhidmatan_akademik, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
