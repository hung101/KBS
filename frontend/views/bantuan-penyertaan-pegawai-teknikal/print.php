...
<table>
    <tr>
        <td>NAMA KEJOHANAN</td><td>:</td><td><?= $model->nama_kejohanan ?></td>
    </tr>
    <tr>
        <td>PERINGKAT</td><td>:</td><td><?= $model->peringkat ?></td>
    </tr>
	<tr>
        <td>PERINGKAT LAIN-LAIN</td><td>:</td><td><?= $model->peringkat_lain_lain ?></td>
    </tr>
    <tr>
	...
	<tr>
        <td>NEGARA</td><td>:</td><td><?= $model->negara ?></td>
    </tr>
    <tr>
	...
	<tr>
        <td><?= strtoupper("Surat Jemputan / Lantikan Daripada Pengelola") ?></td><td>:</td><td><?= ($model->surat_jemputan_lantikan_daripada_pengelola != '')?'Ya (Sila rujuk lampiran di dalam sistem)':'Tiada maklumat' ?></td>
    </tr>
	<tr>
...
<table border="1" cellspacing="0" cellpadding="4" width="100%">
	...
	<?php
	foreach($BantuanPenyertaanPegawaiTeknikalDicadangkan as $key => $value){
	?>
	<tr>
...
<div class="title-header-wrap" style="margin:20px 0px; padding:5px">
    <?= strtoupper("Maklumat Kejohanan Yang Telah Disertai Oleh Pegawai") ?>
</div>
...
<table border="1" cellspacing="0" cellpadding="4" width="100%">
	...
	<?php
	foreach($BantuanPenyertaanPegawaiTeknikalDisertai as $key => $value){
	?>
	<tr>
		<td align="center"><?= $key+1 ?></td>
...
<div class="title-header-wrap" style="margin:20px 0px; padding:5px">
    <?= strtoupper("Bantuan Penyertaan Pegawai Teknikal Ke Kejohanan Dalam Dan Luar Negara Oleh MSN (Tahun Semasa & Tahun Sebelum)") ?>
</div>
...
<table border="1" cellspacing="0" cellpadding="4" width="100%">
	...
	<?php
	foreach($BantuanPenyertaanPegawaiTeknikalOlehMsn as $key => $value){
	?>
	<tr>
		<td align="center"><?= $key+1 ?></td>
