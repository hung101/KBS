...
/* @var $model frontend\models\PengurusanPermohonanKursusPersatuanSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="pengurusan-permohonan-kursus-persatuan-search">
    ...
    <?php // echo $form->field($model, 'yuran_program') ?>
