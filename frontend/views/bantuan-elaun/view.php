...
<div class="bantuan-elaun-view">
    ...
    <p>
        <?php if((isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-elaun']['create']) && $model->hantar_flag == 0)): ?>
            <?= Html::a(GeneralLabel::send, ['hantar', 'id' => $model->bantuan_elaun_id], [
        ...
        <?php endif; ?>
        <?php if((isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-elaun']['update']) && $model->hantar_flag == 0) || isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-elaun']['status_permohonan'])): ?>
            <?= Html::a(GeneralLabel::update, ['update', 'id' => $model->bantuan_elaun_id], ['class' => 'btn btn-primary']) ?>
        <?php endif; ?>
        <?php if((isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-elaun']['delete']) && $model->hantar_flag == 0) || isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-elaun']['status_permohonan'])): ?>
