...
/* @var $model app\models\PenilaianPesertaKursusSoalan */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="penilaian-peserta-terhadap-kursus-soalan-form">
            ...
            'attributes' => [
                 'kategori_soalan' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-kategori-soalan-peserta/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefKategoriSoalanPeserta::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
                 ...
                 'soalan' => [
                    ...
                    'options'=>[
                        ...
                        'select2Options'=> [
                            ...
                            [
                                'append' => [
                                    'content' => Html::a(Html::icon('edit'), ['/ref-soalan-peserta/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                    'asButton' => true
                                ]
                            ] : null,
                        ],
                        'data'=>ArrayHelper::map(RefSoalanPeserta::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
                        'options'=>['prompt'=>'',],
                        'pluginOptions' => [
                            'depends'=>[Html::getInputId($model, 'kategori_soalan')],
                            'initialize' => true,
                            'placeholder' => Placeholder::soalan,
                            'url'=>Url::to(['/ref-soalan-peserta/sub-soalan'])],
                        ],
    ...
    <!--<?= $form->field($model, 'penilaian_peserta_terhadap_kursus_id')->textInput() ?>
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#penilaianPesertaKursusSoalanGrid'});
                }
          }
     });
     return false;
