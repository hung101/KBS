...
<div class="bantuan-penganjuran-kursus-pegawai-teknikal-elemen-form">
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#bantuanPenganjuranKursusPegawaiTeknikalElemenGrid'});
                }
          }
     });
     return false;
...
$('#bantuanpenganjurankursuspegawaiteknikalelemen-kadar').on("keyup", function(){calculateJumlah();});
$('#bantuanpenganjurankursuspegawaiteknikalelemen-bilangan').on("keyup", function(){calculateJumlah();});
$('#bantuanpenganjurankursuspegawaiteknikalelemen-hari').on("keyup", function(){calculateJumlah();});
...
function calculateJumlah(){
    ...
    if($('#bantuanpenganjurankursuspegawaiteknikalelemen-kadar').val() > 0){kadar = parseFloat($('#bantuanpenganjurankursuspegawaiteknikalelemen-kadar').val());}
    if($('#bantuanpenganjurankursuspegawaiteknikalelemen-bilangan').val() > 0){bilangan = parseInt($('#bantuanpenganjurankursuspegawaiteknikalelemen-bilangan').val());}
    if($('#bantuanpenganjurankursuspegawaiteknikalelemen-hari').val() > 0){hari = parseInt($('#bantuanpenganjurankursuspegawaiteknikalelemen-hari').val());}
    
    // Jumlah formula
    jumlah = kadar * bilangan * hari;
        
    //display at fields accordingly
    $('#bantuanpenganjurankursuspegawaiteknikalelemen-jumlah').val(jumlah);
}  
