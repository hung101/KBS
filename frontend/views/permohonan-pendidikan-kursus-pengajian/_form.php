...
<div class="permohonan-pendidikan-kursus-pengajian-form">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                ...
                'universiti' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>80]],
            ],
        ],
    ]
]);
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#permohonanPendidikanKursusPengajianGrid'});
                }
          }
     });
     return false;
