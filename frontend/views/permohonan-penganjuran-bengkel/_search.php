...
/* @var $model frontend\models\PermohonanPenganjuranBengkelSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="permohonan-penganjuran-bengkel-search">
    ...
    <?= $form->field($model, 'permohonan_penganjuran_bengkel_id') ?>
    ...
    <?php // echo $form->field($model, 'bil_penceramah') ?>

    <?php // echo $form->field($model, 'bil_peserta') ?>

    <?php // echo $form->field($model, 'bil_urusetia') ?>
