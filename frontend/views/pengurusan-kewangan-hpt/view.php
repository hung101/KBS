...
$this->title = GeneralLabel::viewTitle . ' ' . GeneralLabel::pengurusan_kewangan_hpt;
$this->params['breadcrumbs'][] = ['label' => GeneralLabel::pengurusan_kewangan_hpt, 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pengurusan-kewangan-hpt-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pengurusan-kewangan-hpt']['update'])): ?>
            <?= Html::a(GeneralLabel::update, ['update', 'id' => $model->pengurusan_kewangan_id], ['class' => 'btn btn-primary']) ?>
        <?php endif; ?>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pengurusan-kewangan-hpt']['delete'])): ?>
