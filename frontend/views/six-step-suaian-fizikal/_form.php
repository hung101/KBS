            ...
            'attributes' => [
                'stage' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-sixstep-suaian-fizikal-stage/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefSixstepSuaianFizikalStage::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
...
'pluginOptions' => [
                ...
                'status' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-sixstep-suaian-fizikal-status/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefSixstepSuaianFizikalStatus::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
...
'pluginOptions' => [
    ...
    if($model->muat_naik){
        ...
        if(!$readonly){
            echo Html::a(GeneralLabel::remove, ['deleteupload', 'id'=>$model->six_step_id, 'field'=> 'muat_naik'], 
            [
