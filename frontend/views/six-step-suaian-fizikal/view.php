...
$this->params['breadcrumbs'][] = ['label' => 'Six Steps', 'url' => ['index']];
...
<div class="six-step-view">
    ...
    <p>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-suaian-fizikal']['update'])): ?>
            <?= Html::a(GeneralLabel::update, ['update', 'id' => $model->six_step_id], ['class' => 'btn btn-primary']) ?>
        <?php endif; ?>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-suaian-fizikal']['delete'])): ?>
