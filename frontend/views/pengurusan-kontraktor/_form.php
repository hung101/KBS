...
<div class="pengurusan-kontraktor-form">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'nama_kontraktor' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>6],'options'=>['maxlength'=>80]],
                'peralatan_yang_dibekal' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>5],'options'=>['maxlength'=>80]],
            ],
        ],
        [
            'attributes' => [
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                'telefon_pejabat' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>14]],
                 'telefon_bimbit' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>3],'options'=>['maxlength'=>14]],
    ...
    <!--<?= $form->field($model, 'nama_kontraktor')->textInput(['maxlength' => 80]) ?>
    ...
    <?= $form->field($model, 'telefon_pejabat')->textInput(['maxlength' => 14]) ?>

    <?= $form->field($model, 'telefon_bimbit')->textInput(['maxlength' => 14]) ?>

    <?= $form->field($model, 'peralatan_yang_dibekal')->textInput(['maxlength' => 80]) ?>-->
