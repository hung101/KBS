    ...
    <div class="wrap">
        <?php
            ...
            if (Yii::$app->user->isGuest || Yii::$app->user->identity->is_new_user == "YES" || Yii::$app->user->identity->password_expiry < date('Y-m-d H:i:s', time()) ) {
				...
				$sideMenuItems[] = [
					'label' => GeneralLabel::pengurusan_atlet, 
					'items' => [
						[
							...
							'items' => [
								[
									...
									'items' => [
										...
										['label' => GeneralLabel::tawaran, 'url' => ['/atlet/tawaran'], 'visible' => (isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['tawaran']) && !isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['tawaran']))],
										[
											'label' => GeneralLabel::laporan,
											'items' => [
												['label' => GeneralLabel::laporan_senarai_atlet, 'url' => ['/atlet/laporan-senarai-atlet'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_atlet_pencapaian_prestasi, 'url' => ['/atlet/laporan-atlet-pencapaian-prestasi'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_atlet_pencapaian_prestasi_secara_individu, 'url' => ['/atlet/laporan-atlet-pencapaian-prestasi-secara-individu'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_atlet_elaun, 'url' => ['/atlet/laporan-atlet-elaun'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_atlet_pakaian_sukan, 'url' => ['/atlet/laporan-atlet-pakaian-sukan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet, 'url' => ['/atlet/laporan-statistik-atlet'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet_agama, 'url' => ['/atlet/laporan-statistik-atlet-agama'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet_bangsa, 'url' => ['/atlet/laporan-statistik-atlet-bangsa'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet_pendidikan, 'url' => ['/atlet/laporan-statistik-atlet-pendidikan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet_umur, 'url' => ['/atlet/laporan-statistik-atlet-umur'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet_jantina, 'url' => ['/atlet/laporan-statistik-atlet-jantina'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_atlet_institusi_sekolah, 'url' => ['/atlet/laporan-statistik-atlet-institusi-sekolah'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
												['label' => GeneralLabel::laporan_elaun_atlet_mengikut_sukan, 'url' => ['/atlet/laporan-elaun-atlet-mengikut-sukan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
											],
										],					
									]
								],
								[
                                                                    ...
                                                                    'items' => [
                                                                        ...
                                                                        [
                                                                            'label' => GeneralLabel::laporan,
                                                                            'items' => [
                                                                                    ['label' => GeneralLabel::laporan_senarai_atlet_paralimpik, 'url' => ['/atlet/laporan-senarai-atlet-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_atlet_pencapaian_prestasi_paralimpik, 'url' => ['/atlet/laporan-atlet-pencapaian-prestasi-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_atlet_pencapaian_prestasi_secara_individu_paralimpik, 'url' => ['/atlet/laporan-atlet-pencapaian-prestasi-secara-individu-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_atlet_elaun_paralimpik, 'url' => ['/atlet/laporan-atlet-elaun-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_atlet_pakaian_sukan_paralimpik, 'url' => ['/atlet/laporan-atlet-pakaian-sukan-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_agama_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-agama-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_bangsa_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-bangsa-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_pendidikan_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-pendidikan-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_umur_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-umur-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_jantina_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-jantina-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_statistik_atlet_institusi_sekolah_paralimpik, 'url' => ['/atlet/laporan-statistik-atlet-institusi-sekolah-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet-cacat']['laporan'])],
                                                                                    ['label' => GeneralLabel::laporan_elaun_atlet_mengikut_sukan_paralimpik, 'url' => ['/atlet/laporan-elaun-atlet-mengikut-sukan-paralimpik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['atlet']['laporan'])],
                                                                            ],
                                                                        ],					
                                                                    ]
								],
								...
								[
									...
									'items' => [
										...
										[
											'label' => GeneralLabel::laporan,
											'items' => [
												['label' => GeneralLabel::laporan_statistik_bayaran_skim_insentif_msn, 'url' => ['/pembayaran-insentif/laporan-statistik-bayaran-skim-insentif-msn'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pembayaran-insentif']['laporan'])],
												['label' => GeneralLabel::laporan_hadiah_kemenangan_untuk_temasya_sukan, 'url' => ['/pembayaran-insentif/laporan-hadiah-kemenangan-untuk-temasya-sukan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pembayaran-insentif']['laporan'])],
												['label' => GeneralLabel::laporan_insentif_atlet, 'url' => ['/pembayaran-insentif/laporan-insentif-atlet'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pembayaran-insentif']['laporan'])],
												['label' => GeneralLabel::laporan_insentif_atlet_keseluruhan, 'url' => ['/pembayaran-insentif/laporan-insentif-atlet-keseluruhan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pembayaran-insentif']['laporan'])],
												['label' => GeneralLabel::laporan_skim_hadiah_kemenangan_mengikut_atlet, 'url' => ['/pembayaran-insentif/laporan-skim-hadiah-kemenangan-sukan-mengikut-atlet'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pembayaran-insentif']['laporan'])],
											],
										],
									],
								],
								[
									'label' => GeneralLabel::kebajikan, 
									'items' => [
										...
										[
											'label' => GeneralLabel::laporan,
											'items' => [
												['label' => GeneralLabel::laporan_skim_kebajikan, 'url' => ['/skim-kebajikan/laporan-skim-kebajikan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['skim-kebajikan']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_pemberian_skak, 'url' => ['/skim-kebajikan/laporan-statistik-pemberian-skak'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['skim-kebajikan']['laporan'])],
											],
										],
									],
								],
								...
								[
									'label' => GeneralLabel::kejohanan_temasya,
									'items' => [
							...
							'items' => [
								...
								[
									...
									'items' => [
										...
										['label' => GeneralLabel::pemantauan_jurulatih, 'url' => ['/laporan-pemantauan-jurulatih/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['laporan-pemantauan-jurulatih']['module'])],
									],
								],
								...
								[
									'label' => GeneralLabel::pengurusan_laporan,
									'items' => [
										...
										['label' => GeneralLabel::laporan_kewangan_elaun_jurulatih, 'url' => ['/gaji-dan-elaun-jurulatih/laporan-kewangan-elaun-jurulatih'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['geran-bantuan-gaji']['laporan'])],
                                                                                ['label' => GeneralLabel::laporan_kewangan_gaji_jurulatih, 'url' => ['/gaji-dan-elaun-jurulatih/laporan-kewangan-gaji-jurulatih'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['geran-bantuan-gaji']['laporan'])],
						...
						[
							'label' => GeneralLabel::prestasi_sukan, 
							'items' => [
								[
									'label' => 'HPT',
									'items' => [
                                        ['label' => GeneralLabel::kewangan, 'url' => ['/pengurusan-kewangan-hpt/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pengurusan-kewangan-hpt']['module'])],
                                        ['label' => GeneralLabel::soal_selidik, 'url' => ['/soal-selidik-sebelum-ujian-hpt/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['soal-selidik-sebelum-ujian-hpt']['module'])],
										[
											'label' => GeneralLabel::program,
											'items' => [
												['label' => GeneralLabel::perancangan, 'url' => ['/perancangan-program-hpt/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['perancangan-program-hpt']['module'])],
												['label' => GeneralLabel::laporan_bulanan, 'url' => ['/hpt-laporan-bulanan-pegawai/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['hpt-laporan-bulanan-pegawai']['module'])],
											]
										],
										['label' => GeneralLabel::six_step, 'url' => ['/six-step/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step']['module'])],
                                                                                ['label' => GeneralLabel::mesyuarat, 'url' => ['/mesyuarat/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['mesyuarat']['module'])],
										[
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_senarai_program, 'url' => ['/perancangan-program-hpt/laporan-senarai-program-setiap-bulan-hpt'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['perancangan-program-hpt']['module'])],
                                                ['label' => GeneralLabel::laporan_bilangan_program, 'url' => ['/perancangan-program-hpt/laporan-bilangan-program-bagi-setiap-bulan-hpt'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['perancangan-program-hpt']['module'])],
                                                ['label' => GeneralLabel::laporan_bulanan_pegawai, 'url' => ['/hpt-laporan-bulanan-pegawai/laporan-senarai-hpt-laporan-bulanan-pegawai'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['hpt-laporan-bulanan-pegawai']['module'])],
                                            ],
                                        ],
									],
								],
								[
									'label' => GeneralLabel::suaian_fizikal,
									'items' => [
										['label' => GeneralLabel::pendaftaran_GYM, 'url' => ['/pendaftaran-gym/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pendaftaran-gym']['module'])],
										...
										['label' => GeneralLabel::kemudahan_dan_peralatan, 'url' => ['/pengurusan-kemudahan-dan-peralatan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pengurusan-kemudahan-dan-peralatan']['module'])],
										['label' => GeneralLabel::pengurusan_dan_analisis_pembekal, 'url' => ['/pengurusan-kontraktor/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pengurusan-kontraktor']['module'])],
										['label' => GeneralLabel::six_step, 'url' => ['/six-step-suaian-fizikal/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-suaian-fizikal']['module'])],
										[
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
								...
								[
									'label' => GeneralLabel::psikologi,
									'items' => [
										['label' => GeneralLabel::profil, 'url' => ['/psikologi-profil/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['psikologi-profil']['module'])],
										['label' => GeneralLabel::six_step, 'url' => ['/six-step-psikologi/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-psikologi']['module'])],
									]
								],
								[
									'label' => GeneralLabel::fisiologi,
									'items' => [
										['label' => GeneralLabel::penjadualan_ujian, 'url' => ['/penjadualan-ujian-fisiologi/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['penjadualan-ujian-fisiologi']['module'])],
										['label' => GeneralLabel::soal_selidik, 'url' => ['/soal-selidik-sebelum-ujian/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['soal-selidik-sebelum-ujian']['module'])],
										['label' => GeneralLabel::six_step, 'url' => ['/six-step-fisiologi/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-fisiologi']['module'])],
										[
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
								...
								[
									'label' => GeneralLabel::biomekanik,
									'items' => [
										['label' => GeneralLabel::permohonan_perkhidmatan, 'url' => ['/permohonan-perkhidmatan-analisa-perlawanan-dan-bimekanik/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-analisa-perlawanan-dan-bimekanik']['module'])],
										['label' => GeneralLabel::pengkalan_data, 'url' => ['/perkhidmatan-analisa-perlawanan-biomekanik/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['perkhidmatan-analisa-perlawanan-biomekanik']['module'])],
										['label' => GeneralLabel::pengurusan_peralatan, 'url' => ['/pinjaman-peralatan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pinjaman-peralatan']['module'])],
										['label' => GeneralLabel::analisa, 'url' => ['/permohonan-perkhidmatan-analisa-perlawanan-dan-bimekanik/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-analisa-perlawanan-dan-bimekanik']['module'])],
										//['label' => GeneralLabel::permohonan_khidmat_biomekanik , 'url' => ['/permohonan-perkhidmatan-analisa-perlawanan-dan-bimekanik/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-analisa-perlawanan-dan-bimekanik']['module'])],
										['label' => GeneralLabel::six_step, 'url' => ['/six-step-biomekanik/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-biomekanik']['module'])],
										[
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_perkhidmatan, 'url' => ['/perkhidmatan-analisa-perlawanan-biomekanik/laporan-perkhidmatan-biomekanik-atlet'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['perkhidmatan-analisa-perlawanan-biomekanik']['module'])],
                                                ['label' => GeneralLabel::laporan_bilangan_perkhidmatan, 'url' => ['/perkhidmatan-analisa-perlawanan-biomekanik/laporan-perkhidmatan-biomekanik-bilangan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['perkhidmatan-analisa-perlawanan-biomekanik']['module'])],
												['label' => GeneralLabel::laporan_pinjaman_peralatan, 'url' => ['/pinjaman-peralatan/laporan-gym-kehadiran-atlet'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pinjaman-peralatan']['module'])],
                                            ],
                                        ],
									]
								],
								[
									'label' => GeneralLabel::pemakanan,
									'items' => [
										['label' => GeneralLabel::perkhidmatan_pemakanan_sukan, 'url' => ['/permohonan-perkhidmatan-permakanan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-permakanan']['module'])],
                                        ...
                                        [
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_analisis_tubuh_badan, 'url' => ['/perkhidmatan-permakanan/laporan-statistik-analisi-tubuh-badan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-permakanan']['module'])],
                                                ['label' => GeneralLabel::laporan_makanan_tambahan, 'url' => ['/perkhidmatan-permakanan/laporan-statistik-makanan-tambahan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-permakanan']['module'])],
                                                ['label' => GeneralLabel::laporan_jus, 'url' => ['/perkhidmatan-permakanan/laporan-statistik-jus'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-perkhidmatan-permakanan']['module'])],
                                            ],
                                        ],
									]
								],
								[
									'label' => GeneralLabel::bakat,
									'items' => [
										['label' => GeneralLabel::maklumat, 'url' => ['/ujian-saringan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['ujian-saringan']['module'])],
                                        [
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
								...
								[
									'label' => GeneralLabel::isn_negeri,
									'items' => [
										['label' => GeneralLabel::perlaporan, 'url' => ['/satelit/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['satelit']['module'])],
										['label' => GeneralLabel::six_step, 'url' => ['/six-step-satelit/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-satelit']['module'])],
										[
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
								...
								[
									...
									'items' => [
										['label' => GeneralLabel::pengurusan_penyelidikan, 'url' => ['/permohonan-penyelidikan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-penyelidikan']['module'])],
										['label' => GeneralLabel::pengurusan_penerbitan, 'url' => ['/journal/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['journal']['module'])],
										['label' => GeneralLabel::permohonan_projek_inovasi, 'url' => ['/permohonan-inovasi-peralatan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-inovasi-peralatan']['module'])],
								...
								[
									...
									'items' => [
										...
										[
											'label' => GeneralLabel::laporan,
											'items' => [
												['label' => GeneralLabel::anggaran_perbelanjaan_title, 'url' => ['/perancangan-program-plan/laporan-kewangan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['perancangan-program']['module'])],
											],
										],
									],
								],
						...
						[
							...
							'items' => [
								[
									'label' => GeneralLabel::pendaftaran_pesakit,
									'items' => [
										...
										[
											'label' => GeneralLabel::statistik,
											'items' => [
												['label' => GeneralLabel::laporan_kedatangan_pesakit, 'url' => ['/pl-temujanji/laporan-temujanji-kedatangan-pesakit'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji']['module'])],
												['label' => GeneralLabel::laporan_temujanji, 'url' => ['/pl-temujanji/laporan-temujanji-kedatangan-pegawai'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji']['module'])],
												['label' => GeneralLabel::laporan_status, 'url' => ['/pl-temujanji/laporan-temujanji-mengikut-status'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji']['module'])],
												['label' => GeneralLabel::laporan_mengikut_sukan, 'url' => ['/pl-temujanji/laporan-temujanji-mengikut-sukan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji']['module'])],
											],
										],
									],
								],
                                ...
                                [
                                    ...
                                    'items' => [
                                        ...
                                        [
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_temujanji, 'url' => ['/pl-temujanji-fisioterapi/laporan-temujanji-fisioterapi'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji-fisioterapi']['module'])],
                                ...
                                [
                                    ...
                                    'items' => [
                                        ...
                                        [
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_ringkasan, 'url' => ['/farmasi-permohonan-liputan-perubatan-sukan/laporan-ringkasan-statistik'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['farmasi-permohonan-liputan-perubatan-sukan']['module'])],
                                                ['label' => GeneralLabel::laporan_bilangan_program, 'url' => ['/farmasi-permohonan-liputan-perubatan-sukan/laporan-ringkasan-statistik-bulanan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['farmasi-permohonan-liputan-perubatan-sukan']['module'])],
                                                ['label' => GeneralLabel::laporan_bulanan, 'url' => ['/farmasi-permohonan-liputan-perubatan-sukan/laporan-bulanan-secara-detail'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['farmasi-permohonan-liputan-perubatan-sukan']['module'])],
                                                //['label' => GeneralLabel::laporan_statistik_bulanan_pengunaan_ubatan_dan_kos, 'url' => ['/farmasi-permohonan-ubatan/laporan-statistik-bulanan-pengunaan-ubatan-dan-kos'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['farmasi-permohonan-ubatan']['module'])],
                                            ],
                                        ],
                                    ],
								...
								[
                                    'label' => GeneralLabel::program_pendidikan_kesihatan,
                                    'items' => [
                                        ['label' => GeneralLabel::permohonan, 'url' => ['/permohonan-program-pendidikan-kesihatan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-program-pendidikan-kesihatan']['module'])],
                                        [
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_ringkasan, 'url' => ['/permohonan-program-pendidikan-kesihatan/laporan-ringkasan-statistik-program-pendidikan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-program-pendidikan-kesihatan']['module'])],
                                                ['label' => GeneralLabel::laporan_bulanan, 'url' => ['/permohonan-program-pendidikan-kesihatan/laporan-bulanan-program-pendidikan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-program-pendidikan-kesihatan']['module'])],
                                            ],
                                        ],
                                    ],
                                ],
								[
                                    'label' => GeneralLabel::komplementari,
                                    'items' => [
                                        ['label' => GeneralLabel::temujanji, 'url' => ['/temujanji-komplimentari/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['temujanji-komplimentari']['module'])],
                                        [
                                            'label' => GeneralLabel::statistik,
                                            'items' => [
                                                ['label' => GeneralLabel::laporan_mengikut_sukan, 'url' => ['/temujanji-komplimentari/laporan-komplimentori'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['temujanji-komplimentari']['module'])],
                                                ['label' => GeneralLabel::laporan_tahunan, 'url' => ['/temujanji-komplimentari/laporan-ringkasan-statistik-komplimentari'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['ISN']['temujanji-komplimentari']['module'])],
                                            ],
                                        ],
                                    ],
                                ],
				...
				$sideMenuItems[] = 	[
					...
					'items' => [
						...
						[
							...
							'items' => [
								...
								[
									'label' => GeneralLabel::laporan,
									'items' => [
										['label' => GeneralLabel::laporan_statistik_bantuan_penganjuran_kejohanan_mengikut_badan_sukan, 'url' => ['/bantuan-penganjuran-kejohanan/laporan-statistik-bantuan-penganjuran-kejohanan-mengikut-badan-sukan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-penganjuran-kejohanan']['laporan'])],
										['label' => GeneralLabel::laporan_senarai_bantuan_geran_kejohanan, 'url' => ['/bantuan-penganjuran-kejohanan/laporan-senarai-bantuan-geran-kejohanan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-penganjuran-kejohanan']['laporan'])],
									],
								],
							],
						],
						[
							...
							'items' => [
								['label' => GeneralLabel::profil, 'url' => ['/maklumat-pegawai-teknikal/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['maklumat-pegawai-teknikal']['module'])],
								['label' => GeneralLabel::manual_silibus_kurikulum, 'url' => ['/manual-silibus-kurikulum-teknikal-kepegawaian/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['manual-silibus-kurikulum-teknikal-kepegawaian']['module'])],
								...
								[
									'label' => GeneralLabel::geran_bantuan,
									'items' => [
										['label' => GeneralLabel::penganjuran_kursus_bengkel_seminar, 'url' => ['/bantuan-penganjuran-kursus/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-penganjuran-kursus']['module'])],
										['label' => GeneralLabel::penyertaan_ke_kejohanan, 'url' => ['/bantuan-penyertaan-pegawai-teknikal/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-penyertaan-pegawai-teknikal']['module'])],
										['label' => GeneralLabel::penyertaan_mengikuti_kursus, 'url' => ['/bantuan-penganjuran-kursus-pegawai-teknikal/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['bantuan-penganjuran-kursus-pegawai-teknikal']['module'])],
									],
								],
								[
									'label' => GeneralLabel::laporan,
						...
						[
							'label' => GeneralLabel::jawatankuasa_sukan,
							'items' => [
				...
				$sideMenuItems[] =	[
					'label' => GeneralLabel::pengurusan_sukan, 
					'items' => [
						[
							'label' => GeneralLabel::persatuan_sukan_kebangsaan." (PSK)",
							'items' => [
                                                                ['label' => GeneralLabel::profil_psk, 'url' => ['/profil-badan-sukan/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['PJS']['profil-badan-sukan']['module'])],
								['label' => GeneralLabel::profil_psk, 'url' => ['/profil-badan-sukan/index-msn'], 'visible' => (isset(Yii::$app->user->identity->peranan_akses['MSN']['pengurusan-maklumat-psk']['module']) && !isset(Yii::$app->user->identity->peranan_akses['PJS']['profil-badan-sukan']['module']))],
								[
								...
								[
									...
									'items' => [
										['label' => GeneralLabel::profil_panel, 'url' => ['/profil-panel-penasihat-kpsk/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['profil-panel-penasihat-kpsk']['module'])],
										['label' => GeneralLabel::profil_peserta, 'url' => ['/borang-profil-peserta-kpsk/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-profil-peserta-kpsk']['module'])],
										...
										[
											'label' => GeneralLabel::laporan,
											'items' => [
												['label' => GeneralLabel::laporan_statistik_kehadiran_peserta_mengikut_kursus_jantina, 'url' => ['/borang-profil-peserta-kpsk/laporan-statistik-kehadiran-peserta-mengikut-kursus-jantina'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-profil-peserta-kpsk']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_kehadiran_peserta_mengikut_kursus_bangsa, 'url' => ['/borang-profil-peserta-kpsk/laporan-statistik-kehadiran-peserta-mengikut-kursus-bangsa'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-profil-peserta-kpsk']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_kehadiran_peserta_mengikut_kursus_umur, 'url' => ['/borang-profil-peserta-kpsk/laporan-statistik-kehadiran-peserta-mengikut-kursus-umur'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-profil-peserta-kpsk']['laporan'])],
												['label' => GeneralLabel::laporan_statistik_keputusan_peserta_mengikut_kursus, 'url' => ['/borang-profil-peserta-kpsk/laporan-statistik-keputusan-peserta-mengikut-kursus'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-profil-peserta-kpsk']['laporan'])],
												['label' => GeneralLabel::laporan_senarai_kehadiran_peserta_mengikut_kursus, 'url' => ['/borang-profil-peserta-kpsk/laporan-senarai-kehadiran-peserta-mengikut-kursus'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-profil-peserta-kpsk']['laporan'])],
												//['label' => GeneralLabel::laporan_kelemahan_program_kursus, 'url' => ['/penilaian-peserta-terhadap-kursus/laporan-kelemahan-program-kursus'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['penilaian-peserta-terhadap-kursus']['laporan'])],
												['label' => GeneralLabel::laporan_program_kursus, 'url' => ['/pengurusan-permohonan-kursus-persatuan/laporan-program-kursus'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pengurusan-permohonan-kursus-persatuan']['laporan'])],
											],
										],
									],
								],
								['label' => GeneralLabel::laporan_tahunan, 'url' => ['/ltbs-minit-mesyuarat-jawatankuasa/index','profil_badan_sukan_id' => ''], 'visible' => (isset(Yii::$app->user->identity->peranan_akses['PJS']['ltbs-minit-mesyuarat-jawatankuasa']['module']) && !Yii::$app->user->identity->profil_badan_sukan)],
                                                                ['label' => GeneralLabel::penganjuran_acara, 'url' => ['/paobs-penganjuran/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['PJS']['paobs-penganjuran']['module'])],
                                                                ['label' => GeneralLabel::latihan_pendidikan, 'url' => ['/latihan-dan-program/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['PJS']['latihan-dan-program']['module'])],
                                                                ...
                                                                [
                                                                    ...
                                                                    'items' => [
                                                                        ...
                                                                        [
                                                                            ...
                                                                            'items' => [
                                                                                ['label' => GeneralLabel::laporan_tahunan, 'url' => ['/ltbs-minit-mesyuarat-jawatankuasa/maklumat-mesyuarat-agung-tahunan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['PJS']['ltbs-minit-mesyuarat-jawatankuasa']['module'])],
						...
						[
							...
							'items' => [
								...
								[
									'label' => GeneralLabel::venue_kemudahan,
									'items' => [
										...
										[
											...
											'items' => [
												...
												['label' => GeneralLabel::laporan_statistik_kemudahan_jumlah_peserta_mengikut_venue, 'url' => ['/tempahan-kemudahan-msn/laporan-statistik-kemudahan-jumlah-peserta-mengikut-venue'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-msn']['module'])],
                                                                                            ['label' => GeneralLabel::laporan_bulanan_penggunaan_agensi_di_venue, 'url' => ['/tempahan-kemudahan-msn/laporan-statistik-kemudahan-jumlah-mengikut-agensi'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-msn']['module'])],
											],
										],
									],
								],
									...
									'items' => [
										...
										//['label' => GeneralLabel::pengurusan_kemudahan_aduan_pemeriksa, 'url' => ['/pengurusan-kemudahan-aduan-pemeriksa/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['pengurusan-kemudahan-aduan-pemeriksa']['module'])],
                                                                            [
                                                                                'label' => GeneralLabel::laporan,
                                                                                'items' => [
                                                                                    ['label' => GeneralLabel::laporan_aduan_kerosakan, 'url' => ['/borang-aduan-kerosakan/laporan-aduan-kerosakan'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['MSN']['borang-aduan-kerosakan']['laporan'])],
                                                                                ],
                                                                            ],
									],
								],
						...
						[
							'label' => GeneralLabel::kaunseling_dan_kerjaya,
							'items' => [
						...
						[
							...
							'items' => [
								...
								['label' => GeneralLabel::e_biasiswa_public_user, 'url' => ['/public-user-e-biasiswa/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['KBS']['public-user-e-biasiswa']['module'])],
                                                                ['label' => GeneralLabel::admin_ebiasiswa, 'url' => ['/admin-e-biasiswa/index'], 'visible' => isset(Yii::$app->user->identity->peranan_akses['KBS']['admin-e-biasiswa']['module'])],
								[
									'label' => GeneralLabel::laporan,
									'items' => [
...
var loginUrl = '<?=Url::to(['/site/login'])?>'; // URL to logout page.

var indexUrl = 'http://<?=Yii::$app->getRequest()->serverName?>/index_spsb.php'; // URL to index page.
...
function checkConcurrent(){
    if('<?=Yii::$app->params['allowConcurrentLogin']?>' == '1'){
        ...
        $.ajax({
            url: '<?=Url::to(['/site/check-concurrent'])?>',
            type: 'GET',
