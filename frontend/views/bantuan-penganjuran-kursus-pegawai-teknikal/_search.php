...
/* @var $model frontend\models\BantuanPenganjuranKursusPegawaiTeknikalSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="bantuan-penganjuran-kursus-pegawai-teknikal-search">
    ...
    <?php // echo $form->field($model, 'nama_kursus_seminar_bengkel') ?>
    ...
    <?php // echo $form->field($model, 'yuran_penyertaan') ?>

    <?php // echo $form->field($model, 'surat_rasmi_badan_sukan') ?>

    <?php // echo $form->field($model, 'surat_jemputan_daripada_pengelola') ?>
