    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filterInputOptions' => [
                    'class'       => 'form-control',
                    'placeholder' => GeneralLabel::filter.' '.GeneralLabel::nama_insentif,
                ],
            ...
            [
                ...
                'filterInputOptions' => [
                    'class'       => 'form-control',
                    'placeholder' => GeneralLabel::filter.' '.GeneralLabel::kumpulan,
                ],
            ...
            [
                ...
                'filterInputOptions' => [
                    'class'       => 'form-control',
                    'placeholder' => GeneralLabel::filter.' '.GeneralLabel::rekod_baru,
                ],
