...
$this->title = GeneralLabel::status_tempahan_kemudahan;
...
<div class="ref-status-tempahan-kemudahan-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::status_tempahan_kemudahan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filterInputOptions' => [
                    'class'       => 'form-control',
                    'placeholder' => GeneralLabel::filter.' '.GeneralLabel::report_flag,
                ],
