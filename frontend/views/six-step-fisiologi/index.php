...
$this->title = GeneralLabel::fisiologi;
...
<div class="six-step-index">
    ...
    <?php
        ...
        // Update Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-fisiologi']['update'])){
            $template .= ' {update}';
        }
        
        // Delete Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-fisiologi']['delete'])){
            $template .= ' {delete}';
        }
    ?>
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-fisiologi']['create'])): ?>
        <p>
