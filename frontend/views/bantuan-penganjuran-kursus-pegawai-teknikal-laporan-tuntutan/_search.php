...
/* @var $model frontend\models\BantuanPenganjuranKursusPegawaiTeknikalLaporanTuntutanSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="bantuan-penganjuran-kursus-pegawai-teknikal-laporan-tuntutan-search">
    ...
    <?= $form->field($model, 'bantuan_penganjuran_kursus_pegawai_teknikal_laporan_tuntutan_id') ?>

    <?= $form->field($model, 'bantuan_penganjuran_kursus_pegawai_teknikal_laporan_id') ?>

    <?= $form->field($model, 'kejohanan_kursus_seminar_bengkel') ?>
