...
<div class="bantuan-penganjuran-kursus-pegawai-teknikal-laporan-tuntutan-form">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'kejohanan_kursus_seminar_bengkel' =>['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>5],'options'=>['maxlength'=>true]],
                 'tarikh_mula' => [
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#bantuanPenganjuranKursusPegawaiTeknikalLaporanTuntutanGrid'});
                }
          }
     });
     return false;
