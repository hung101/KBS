...
$this->title = GeneralLabel::universiti_institusi_ebiasiswa;
...
<div class="ref-universiti-institusi-ebiasiswa-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::universiti_institusi_ebiasiswa, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filterInputOptions' => [
                    'class'       => 'form-control',
                    'placeholder' => GeneralLabel::filter.' '.GeneralLabel::ref_universiti_institusi_kategori_e_biasiswa_id,
                ],
