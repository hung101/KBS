...
$this->title = $model->pengurusan_program_binaan_sukan_id;
...
<div class="pengurusan-program-binaan-atlet-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->pengurusan_program_binaan_sukan_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->pengurusan_program_binaan_sukan_id], [
