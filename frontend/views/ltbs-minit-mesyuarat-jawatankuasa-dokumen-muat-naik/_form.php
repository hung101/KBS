...
<div class="ltbs-minit-mesyuarat-jawatankuasa-dokumen-muat-naik-form">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'nama_dokumen' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>8],'options'=>['maxlength'=>80]],
     ...
     $.ajax({
          ...
          success: function (response) {
               ...
               $(document).find('#modal').modal('hide');
                ...
                $.pjax.reload({container:'#muatNaikGrid'});
          }
     });
     return false;
});
