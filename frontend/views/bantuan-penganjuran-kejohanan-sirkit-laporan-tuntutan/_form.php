...
<div class="bantuan-penganjuran-kejohanan-sirkit-laporan-tuntutan-form">
...
$('#bantuanpenganjurankejohanansirkitlaporantuntutan-jumlah_kelulusan').on("keyup", function(){calculatePendahuluanDituntut();});
...
function calculatePendahuluanDituntut(){
    ...
    if($('#bantuanpenganjurankejohanansirkitlaporantuntutan-jumlah_kelulusan').val() > 0)
    {
        jumlah = parseFloat($('#bantuanpenganjurankejohanansirkitlaporantuntutan-jumlah_kelulusan').val());
        ...
        $('#bantuanpenganjurankejohanansirkitlaporantuntutan-pendahuluan_80').val(jumlahPendahuluan);
        $('#bantuanpenganjurankejohanansirkitlaporantuntutan-jumlah_yang_dituntut_20').val(jumlahDituntut);
    }
