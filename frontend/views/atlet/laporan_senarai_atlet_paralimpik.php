...
$this->title = GeneralLabel::laporan_senarai_atlet_paralimpik;
...
$param_cawangan['cacat'] = 1; //  atlet disabled
...
<div class="laporan-penganjuran-acara">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'umur_dari' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>2],'options'=>['maxlength'=>3]],
                'umur_hingga' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>2],'options'=>['maxlength'=>3]],
            ]
        ],
        [
            'columns'=>12,
            ...
            'attributes' => [
                'kategori_kecacatan' => [
                    ...
                    'options'=>[
                        ...
                        'options' => ['multiple' => true,'placeholder' => Placeholder::kategoriKecacatan],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],],
                    'columnOptions'=>['colspan'=>3]],
            ...
            'attributes' => [
                'source' => [
                    ...
                    'options'=>[
                        ...
                        'options' => ['multiple' => true,'placeholder' => Placeholder::jenis],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],],
                    'columnOptions'=>['colspan'=>3]],
            ...
            'attributes' => [
                'tahap_pendidikan' => [
                    ...
                    'options'=>[
                        ...
                        'options' => ['multiple' => true,'placeholder' => Placeholder::tahapPendidikan],
                        'pluginOptions' => [
                            'allowClear' => true
                        ],],
                    'columnOptions'=>['colspan'=>3]],
