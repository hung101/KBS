...
<div class="pemberian-jus-pemulihan-form">
            ...
            'attributes' => [
                'berat_badan' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-berat-badan/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefBeratBadan::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
    ...
    <?= $form->field($model, 'kategori_atlet')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'sukan')->textInput() ?>

    <?= $form->field($model, 'acara')->textInput() ?>

    <?= $form->field($model, 'atlet')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'nama_jus')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'jenis_jus')->textInput() ?>

    <?= $form->field($model, 'kuantiti')->textInput() ?>

    <?= $form->field($model, 'berat_badan')->textInput() ?>

    <?= $form->field($model, 'buah')->textInput(['maxlength' => true]) ?>
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#pemberianJusPemulihanGrid'});
                }
          }
     });
     return false;
