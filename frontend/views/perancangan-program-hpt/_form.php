...
<div class="perancangan-program-hpt-form">
    ...
    'rows' => [
            ...
            'attributes' => [
                 ...
                 'jenis_program' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-jenis-program-hpt/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefJenisProgramHpt::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                 'lokasi' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>6],'options'=>['maxlength'=>90]],
    ...
    if($model->muat_naik){
        ...
        if(!$readonly){
            echo Html::a(GeneralLabel::remove, ['deleteupload', 'id'=>$model->perancangan_program_id, 'field'=> 'muat_naik'], 
            [
