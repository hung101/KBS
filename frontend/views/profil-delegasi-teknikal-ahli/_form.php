...
<div class="profil-delegasi-teknikal-ahli-form">
    ...
    'rows' => [
            ...
            'attributes' => [
                ...
                'jawatan' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-jawatan-delegasi-teknikal/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                'no_telefon_bimbit' =>  ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>4],'options'=>['maxlength'=>14]],
