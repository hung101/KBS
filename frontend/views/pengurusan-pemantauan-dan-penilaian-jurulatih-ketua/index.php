...
/* @var $searchModel frontend\models\PengurusanPemantauanDanPenilaianJurulatihKetuaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = GeneralLabel::penilaian_ketua_jurulatih;
...
<div class="pengurusan-pemantauan-dan-penilaian-jurulatih-index">
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['MSN']['pengurusan-pemantauan-dan-penilaian-jurulatih']['create'])): ?>
        <p>
            <?= Html::a(GeneralLabel::createTitle . ' ' . GeneralLabel::penilaian_ketua_jurulatih, ['create'], ['class' => 'btn btn-success']) ?>
        </p>
    <?php endif; ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
           ...
           // 'pengurusan_pemantauan_dan_penilaian_ketua_jurulatih_id',
