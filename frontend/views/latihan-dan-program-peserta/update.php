...
$this->title = 'Update Latihan Dan Program Peserta: ' . ' ' . $model->latihan_dan_program_peserta_id;
$this->params['breadcrumbs'][] = ['label' => 'Latihan Dan Program Pesertas', 'url' => ['index']];
