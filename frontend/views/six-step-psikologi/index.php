...
$this->title = GeneralLabel::psikologi;
...
<div class="six-step-index">
    ...
    <?php
        ...
        // Update Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-psikologi']['update'])){
            $template .= ' {update}';
        }
        
        // Delete Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-psikologi']['delete'])){
            $template .= ' {delete}';
        }
    ?>
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-psikologi']['create'])): ?>
        <p>
