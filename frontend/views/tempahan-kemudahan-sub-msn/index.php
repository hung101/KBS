...
?>
<div class="tempahan-kemudahan-sub-msn-index">
    
    <?php
        $template = '{view}';
        
        // Update Access
        if(isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-sub-msn']['update']) || isset(Yii::$app->user->identity->peranan_akses['KBS']['tempahan-kemudahan-sub-msn']['update'])){
            //$template .= ' {update}';
        }
        
        // Delete Access
        if(isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-sub-msn']['delete']) || isset(Yii::$app->user->identity->peranan_akses['KBS']['tempahan-kemudahan-sub-msn']['delete'])){
            //$template .= ' {delete}';
        }
    ?>
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-sub-msn']['create']) || isset(Yii::$app->user->identity->peranan_akses['KBS']['tempahan-kemudahan-sub-msn']['create'])): ?>
        <p>
