...
<div class="tempahan-kemudahan-sub-msn-view">
    ...
    <p>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-sub-msn']['update']) || isset(Yii::$app->user->identity->peranan_akses['KBS']['tempahan-kemudahan-sub-msn']['update'])): ?>
            <?= Html::a(GeneralLabel::update, ['update', 'id' => $model->tempahan_kemudahan_sub_msn_id], ['class' => 'btn btn-primary']) ?>
        <?php endif; ?>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['MSN']['tempahan-kemudahan-sub-msn']['delete']) || isset(Yii::$app->user->identity->peranan_akses['KBS']['tempahan-kemudahan-sub-msn']['delete'])): ?>
