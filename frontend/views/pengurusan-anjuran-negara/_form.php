...
<div class="pengurusan-anjuran-negara-form">
    ...
    'rows' => [
        ...
        [
            ...
            'autoGenerateColumns'=>false, // override columns setting
            'attributes' => [
                'nama_delegasi_luar_negara' => ['type'=>Form::INPUT_TEXTAREA,'columnOptions'=>['colspan'=>3]],
            ],
        ],
    ]
]);
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#pengurusanAnjuranNegaraGrid'});
                }
          }
     });
     return false;
