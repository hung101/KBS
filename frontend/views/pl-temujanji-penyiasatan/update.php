...
$this->title = GeneralLabel::updateTitle . ' ' . GeneralLabel::temujanji_penyiasatan;
$this->params['breadcrumbs'][] = ['label' => GeneralLabel::temujanji_penyiasatan, 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => GeneralLabel::viewTitle . ' ' . GeneralLabel::temujanji_penyiasatan, 'url' => ['view', 'id' => $model->pl_temujanji_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pl-temujanji-penyiasatan-update">
