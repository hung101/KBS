...
$this->title = GeneralLabel::temujanji_penyiasatan;
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pl-temujanji-penyiasatan-index">
    
    <?php
        $template = '{view}';
        
        // Update Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji-penyiasatan']['update'])){
            $template .= ' {update}';
        }
        
        // Delete Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji-penyiasatan']['delete'])){
            $template .= ' {delete}';
        }
    ?>
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji-penyiasatan']['create'])): ?>
        <p>
