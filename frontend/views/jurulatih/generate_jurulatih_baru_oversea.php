...
<table border="0" align="center">
    <tr>
        ...
        EMPLOYMENT ACCEPTANCE LETTER<br />(FOREIGN COCH)<br />(NEW APPOINTMENT)
        </td>
    </tr>
</table>
...
<table cellspacing="0" cellpadding="5">
    <tr>
        ...
        <td>Four (4) recent passport-sized photographs (white background)</td>
    <tr>
    <tr>
        <td>ii)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A copy of employee Passport</td>
    <tr>
    <tr>
        <td>iii)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A copy of employee spouse's / children's Passport</td>
    <tr>
    <tr>
        <td>iv)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A certified copy of Marriage Certificate (if applicable)</td>
    <tr>
    <tr>
        <td>v)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A certified copy of Child's Birth Certificate (if applicable)</td>
    <tr>
    <tr>
        <td>vi)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
    ...
    <tr>
        <td>vii)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A certified copy of academic transcripts/certificate</td>
    <tr>
    <tr>
        <td>viii)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>An original copy of completed Medical Report Form (attached)</td>
    <tr>    
    <tr>
        <td>ix)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A copy of completed Income Tax Form (attached)</td>
    <tr>
    <tr>
        <td>x)</td>
        <td><div class="square">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
        <td>A copy of Foreign Coach's Agreement duly signed by the employee (attached)</td>
    <tr>
</table>
</p>
<p>Thank you.</p>
