...
<div class="paobs-penganjuran-sumber-kewangan-form">
    ...
    'rows' => [
        [
            ...
            'attributes' => [
                'sumber' => ['type'=>Form::INPUT_TEXT,'columnOptions'=>['colspan'=>6],'options'=>['maxlength'=>100]],
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#sumberKewanganGrid'});
                }
          }
     });
     return false;
