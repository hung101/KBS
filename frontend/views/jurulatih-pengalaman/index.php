...
$this->title = GeneralLabel::pengalaman_dalam_penglibatan_sukan_kejurulatihan;
...
<div class="jurulatih-pengalaman-index">
    ...
    <?php Pjax::begin(['id' => GeneralVariable::listPengalamanID, 'timeout' => false, 'enablePushState' => false,]); ?>

    <?= GridView::widget([
        'dataProvider' => $dataProvider,
        'filterModel' => $searchModel,
        'id' => GeneralVariable::listPengalamanID,
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
                'buttons' => [
                    'delete' => function ($url, $model) {
                        ...
                        'onclick' => 'deleteRecordAjax("'.$url.'", "'.GeneralVariable::tabPengalamanID.'", "'.GeneralMessage::confirmDelete.'");',
                    ...
                    'update' => function ($url, $model) {
                        ...
                        'onclick' => 'updateRenderAjax("'.$url.'", "'.GeneralVariable::tabPengalamanID.'");',
                        ]);
                    },
