...
'pluginOptions' => [
            ...
            ['class' => 'yii\grid\ActionColumn',
                'buttons' => [
                    ...
                    'update' => function ($url, $model) {
                        ...
                        'onclick' => 'loadModalRenderAjax("'.Url::to(['pl-diagnosis-preskripsi-pemeriksaan/update', 'id' => $model->pl_diagnosis_preskripsi_pemeriksaan_id]).'", "'.GeneralLabel::updateTitle . ' '.GeneralLabel::diagnosispreskripsipemeriksaanpenyiasatan.'");',
                        ]);
                    },
                    'view' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', 'javascript:void(0);', [
                        'title' => Yii::t('yii', 'View'),
                        'onclick' => 'loadModalRenderAjax("'.Url::to(['pl-diagnosis-preskripsi-pemeriksaan/view', 'id' => $model->pl_diagnosis_preskripsi_pemeriksaan_id]).'", "'.GeneralLabel::viewTitle . ' '.GeneralLabel::diagnosispreskripsipemeriksaanpenyiasatan.'");',
                        ]);
                    }
                ],
                'template' => $template,
    ...
    <p>
        ...
        echo Html::a('<span class="glyphicon glyphicon-plus"></span>', 'javascript:void(0);', [
                        'onclick' => 'loadModalRenderAjax("'.Url::to(['pl-diagnosis-preskripsi-pemeriksaan/create', 'pl_temujanji_id' => $pl_temujanji_id]).'", "'.GeneralLabel::createTitle . ' '.GeneralLabel::diagnosispreskripsipemeriksaanpenyiasatan.'");',
...
<?php
$URLJurulatih = Url::to(['/atlet/get-atlet']);
$DateDisplayFormat = GeneralVariable::displayDateFormat;

$script = <<< JS
        
$('#pltemujanji-atlet_id').change(function(){
    ...
    $.get('$URLJurulatih',{id:$(this).val()},function(data){
        ...
        if(data !== null){
            ...
            if(data.refAtletSukan[0] !== null){ 
                $('#pltemujanji-kategori_atlet').val(data.refAtletSukan[0].program_semasa).trigger("change");
                $('#pltemujanji-jenis_sukan').val(data.refAtletSukan[0].nama_sukan).trigger("change");
            }
        }
    });
});
...
function clearForm(){
    $("#pltemujanji-kategori_atlet").val('').trigger("change");
    $("#pltemujanji-jenis_sukan").val('').trigger("change");
}
