...
$this->title = GeneralLabel::viewTitle . ' ' . GeneralLabel::temujanji;
$this->params['breadcrumbs'][] = ['label' => GeneralLabel::temujanji, 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="pl-temujanji-view">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji']['update'])): ?>
            <?= Html::a(GeneralLabel::update, ['update', 'id' => $model->pl_temujanji_id], ['class' => 'btn btn-primary']) ?>
        <?php endif; ?>
        <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['pl-temujanji']['delete'])): ?>
