...
/* @var $model frontend\models\BantuanPenganjuranKursusOlehMsnSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="bantuan-penganjuran-kursus-oleh-msn-search">
    ...
    <?= $form->field($model, 'bantuan_penganjuran_kursus_oleh_msn_id') ?>
