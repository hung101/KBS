...
<div class="bantuan-penganjuran-kejohanan-laporan-form">
   ...
   ?>
    ...
    'rows' => [
        ...
        [
            'attributes' => [
                'senarai_pasukan' => ['type'=>Form::INPUT_FILE,'options'=>['maxlength'=>true]],
            ]
        ],
        [
            'attributes' => [
                'senarai_statistik_penyertaan' => ['type'=>Form::INPUT_FILE,'options'=>['maxlength'=>true], 'hint' => '( JURULATIH / ATLET (LELAKI / WANITA / BANGSA) )'],
            ]
        ],
        [
            'attributes' => [
                'senarai_pegawai_pembantu_teknikal' => ['type'=>Form::INPUT_FILE,'options'=>['maxlength'=>true]],
            ]
        ],
        [
            'attributes' => [
        ...
        [
            'attributes' => [
                'senarai_pegawai_pembantu_perubatan' => ['type'=>Form::INPUT_FILE,'options'=>['maxlength'=>true]],
            ]
        ],
    ]
]);
    ...
    <p>
        ...
        echo Html::a('<span class="glyphicon glyphicon-plus"></span>', 'javascript:void(0);', [
                        'onclick' => 'loadModalRenderAjax("'.Url::to(['bantuan-penganjuran-kejohanan-laporan-tuntutan/create', 'bantuan_penganjuran_kejohanan_laporan_id' => $bantuan_penganjuran_kejohanan_laporan_id]).'", "'.GeneralLabel::createTitle . ' Tuntutan Baki Dua Puluh Peratus (20%) Daripada Jumlah Kelulusan (Jika Ada)");',
