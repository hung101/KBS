...
<div class="bantuan-profil-pusat-latihan-program-form">
                ...
                'attributes' => [
                    'program' => [
                        ...
                        'options'=>[
                            ...
                            'data'=>ArrayHelper::map(RefProgramSemasaSukanAtlet::find()->where(['=', 'aktif', 1])
                                    //->andWhere(['=', 'cacat', 0])
                                    ->all(),'id', 'desc'),
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#profilPusatLatihanProgramGrid'});
                }
          }
     });
     return false;
