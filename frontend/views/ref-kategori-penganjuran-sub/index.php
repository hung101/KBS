...
$this->title = GeneralLabel::kategori_penganjuran_sub;
...
<div class="ref-kategori-penganjuran-sub-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::kategori_penganjuran_sub, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filterInputOptions' => [
                    'class'       => 'form-control',
                    'placeholder' => GeneralLabel::filter.' '.GeneralLabel::ref_kategori_penganjuran_id,
                ],
