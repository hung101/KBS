            ...
            'attributes' => [
                'stage' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-sixstep-stage/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefSixstepStage::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
...
'pluginOptions' => [
                ...
                'status' => [
                    ...
                    'options'=>[
                        ...
                        [
                            'append' => [
                                'content' => Html::a(Html::icon('edit'), ['/ref-sixstep-status/index'], ['class'=>'btn btn-success', 'target' => '_blank']),
                                'asButton' => true
                            ]
                        ] : null,
                        'data'=>ArrayHelper::map(RefSixstepStatus::find()->where(['=', 'aktif', 1])->all(),'id', 'desc'),
