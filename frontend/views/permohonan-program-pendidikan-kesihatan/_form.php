...
<div class="permohonan-program-pendidikan-kesihatan-form">
   ...
   <p class="text-muted"><span style="color: red">*</span> <?= GeneralLabel::mandatoryField?></p>
    ...
    if($model->muat_naik){
        ...
        if(!$readonly){
            echo Html::a(GeneralLabel::remove, ['deleteupload', 'id'=>$model->permohonan_program_pendidikan_kesihatan_id, 'field'=> 'muat_naik'], 
            [
   ...
   <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-program-pendidikan-kesihatan']['kelulusan_ceo']) || $readonly): ?>
    <?php
        echo FormGrid::widget([
    'model' => $model,
    'form' => $form,
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['permohonan-program-pendidikan-kesihatan']['kelulusan_pbu']) || $readonly): ?>
    <?php
        echo FormGrid::widget([
    'model' => $model,
    'form' => $form,
