                    ...
                    'attributes' => [
						'nama_dokumen' =>  [
							...
							'options'=>[
								...
								'data'=>ArrayHelper::map(RefDokumenGeranBantuanGaji::find()->where(['aktif' => 1])->all(),'id', 'desc'),
        ...
        echo FormGrid::widget([
            ...
            'rows' => [
                    [
                        ...
                        'autoGenerateColumns'=>false, // override columns setting
                        'attributes' => [
                            'lampiran' => ['type'=>Form::INPUT_FILE,'columnOptions'=>['colspan'=>3],'label'=>$label],
                        ],
                    ],
                ]
            ]);
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#geranBantuanGajiLampiranGrid'});
                }
          }
     });
     return false;
