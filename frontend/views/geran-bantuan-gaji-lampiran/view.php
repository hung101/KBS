...
$this->title = $model->geran_bantuan_gaji_lampiran_id;
...
<div class="pengurusan-insuran-lampiran-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->geran_bantuan_gaji_lampiran_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->geran_bantuan_gaji_lampiran_id], [
