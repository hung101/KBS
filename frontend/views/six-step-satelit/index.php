...
/* @var $searchModel frontend\models\SixStepSatelitSearch */
...
<div class="six-step-index">
    ...
    <?php
        ...
        // Update Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-satelit']['update'])){
            $template .= ' {update}';
        }
        
        // Delete Access
        if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-satelit']['delete'])){
            $template .= ' {delete}';
        }
    ?>
    ...
    <?php if(isset(Yii::$app->user->identity->peranan_akses['ISN']['six-step-satelit']['create'])): ?>
        <p>
