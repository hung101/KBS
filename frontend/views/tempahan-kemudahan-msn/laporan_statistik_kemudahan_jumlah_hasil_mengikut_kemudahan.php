...
$this->title = GeneralLabel::laporan_statistik_kemudahan_jumlah_hasil_mengikut_kemudahan;
            ...
            'attributes' => [
                'venue' => [
                    ...
                    'options'=>[
                        ...
                        'data'=>ArrayHelper::map(PengurusanKemudahanVenueMsn::find()->joinWith(['refKategoriHakmilik'])->orderBy(['alamat_negeri' => SORT_ASC])->all(),'pengurusan_kemudahan_venue_id', 'nama_venue'),
