...
<div class="permohonan-kemudahan-ticket-kapal-terbang-atlet-form">
...
<?php
$URLAtlet = Url::to(['/permohonan-kemudahan-ticket-kapal-terbang-atlet/get-atlet']);
          ...
          success: function (response) {
               // do something with response
                ...
                if(response != 1){
                    ...
                    $.pjax.reload({container:'#permohonanKemudahanTicketKapalTerbangAtletGrid'});
                }
          }
     });
     return false;
...
$('#atletId').change(function(){
    $.get('$URLAtlet',{atlet_id:$(this).val()},function(data){
        
        var data = $.parseJSON(data);
        
        if(data !== null){
            $("#permohonankemudahanticketkapalterbangatlet-passport_no").attr('value',data.passport_no);
            $("#permohonankemudahanticketkapalterbangatlet-ic_no").attr('value',data.ic_no);
            $("#permohonankemudahanticketkapalterbangatlet-hp_no").attr('value',data.tel_bimbit_no_1);
        }
    });
});  
