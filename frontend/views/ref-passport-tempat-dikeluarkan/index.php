...
$this->title = GeneralLabel::tempat_passport_dikeluarkan;
...
<div class="ref-passport-tempat-dikeluarkan-index">
    ...
    <p>
        <?= Html::a(GeneralLabel::createTitle.' '.GeneralLabel::tempat_passport_dikeluarkan, ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
