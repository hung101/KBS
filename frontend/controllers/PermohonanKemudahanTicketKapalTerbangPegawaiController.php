...
/**
 * PermohonanKemudahanTicketKapalTerbangPegawaiController implements the CRUD actions for PermohonanKemudahanTicketKapalTerbangPegawai model.
 */
class PermohonanKemudahanTicketKapalTerbangPegawaiController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all PermohonanKemudahanTicketKapalTerbangPegawai models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $searchModel = new PermohonanKemudahanTicketKapalTerbangPegawaiSearch();
    ...
    /**
     * Displays a single PermohonanKemudahanTicketKapalTerbangPegawai model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new PermohonanKemudahanTicketKapalTerbangPegawai model.
    ...
    public function actionCreate($permohonan_kemudahan_ticket_kapal_terbang_id)
    {
        ...
        $model = new PermohonanKemudahanTicketKapalTerbangPegawai();
    ...
    /**
     * Updates an existing PermohonanKemudahanTicketKapalTerbangPegawai model.
    ...
    /**
     * Deletes an existing PermohonanKemudahanTicketKapalTerbangPegawai model.
    ...
    /**
     * Finds the PermohonanKemudahanTicketKapalTerbangPegawai model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return PermohonanKemudahanTicketKapalTerbangPegawai the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = PermohonanKemudahanTicketKapalTerbangPegawai::findOne($id)) !== null) {
            return $model;
        } else {
