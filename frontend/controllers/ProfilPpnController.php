...
use Yii;
use app\models\ProfilPpn;
use frontend\models\ProfilPpnSearch;
...
/**
 * ProfilPpnController implements the CRUD actions for ProfilPpn model.
 */
class ProfilPpnController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $queryPar['ProfilPpnSearch']['peranan'] = UserPeranan::PERANAN_MSN_PPN;
        
        $searchModel = new ProfilPpnSearch();
    ...
    /**
     * Displays a single ProfilPpn model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        $ref = RefNegeri::findOne(['id' => $model->ppn_negeri]);
        $model->ppn_negeri = $ref['desc'];
        
        $ref = RefSukan::findOne(['id' => $model->ppn_sukan]);
        $model->ppn_sukan = $ref['desc'];
        ...
        $ref = RefKategoriJawatan::findOne(['id' => $model->ppn_kategori_jawatan]);
        $model->ppn_kategori_jawatan = $ref['desc'];
    ...
    public function actionCreate()
    {
        ...
        $model->peranan = UserPeranan::PERANAN_MSN_PPN;
        $model->from_module = GeneralVariable::moduleMSNUsptnPpn;
...
".'
    ...
    /**
     * Updates an existing ProfilPpn model.
    ...
    /**
     * Deletes an existing ProfilPpn model.
    ...
    /**
     * Finds the ProfilPpn model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ProfilPpn the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ProfilPpn::findOne($id)) !== null) {
            return $model;
        } else {
