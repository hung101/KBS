...
/**
 * JurulatihAtletController implements the CRUD actions for AtletPerubatanDonator model.
 */
class JurulatihAtletController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if(isset($session['jurulatih_id'])){
            $queryPar['AtletSearch']['jurulatih'] = $session['jurulatih_id'];
        }
