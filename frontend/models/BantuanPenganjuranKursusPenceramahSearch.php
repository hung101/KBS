...
/**
 * BantuanPenganjuranKursusPenceramahSearch represents the model behind the search form about `app\models\BantuanPenganjuranKursusPenceramah`.
 */
class BantuanPenganjuranKursusPenceramahSearch extends BantuanPenganjuranKursusPenceramah
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['bantuan_penganjuran_kursus_penceramah_id', 'bantuan_penganjuran_kursus_id', 'umur', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        $query = BantuanPenganjuranKursusPenceramah::find();
        ...
        $query->andFilterWhere([
            'bantuan_penganjuran_kursus_penceramah_id' => $this->bantuan_penganjuran_kursus_penceramah_id,
