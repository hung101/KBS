 ...
 */
class SixStepPsikologi extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['stage', 'status','catatan'], 'filter', 'filter' => function ($value) {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRefSixstepPsikologiStage(){
        return $this->hasOne(RefSixstepPsikologiStage::className(), ['id' => 'stage']);
    }
    
    /**
     * @return \yii\db\ActiveQuery
     */
    public function getRefSixstepPsikologiStatus(){
        return $this->hasOne(RefSixstepPsikologiStatus::className(), ['id' => 'status']);
    }
}
