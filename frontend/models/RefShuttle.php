...
/**
 * This is the model class for table "tbl_ref_shuttle".
 *
 * @property integer $id
 ...
 */
class RefShuttle extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['phoneno'], 'string', 'max' => 14, 'tooLong' => GeneralMessage::yii_validation_string_max],
