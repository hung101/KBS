 ...
 */
class PengurusanKewanganHpt extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_pengurusan_kewangan_hpt';
    }
    ...
    public function getRefKategoriPenggunaan(){
        return $this->hasOne(RefKategoriPenggunaanHpt::className(), ['id' => 'kategori_penggunaan']);
    }
}
