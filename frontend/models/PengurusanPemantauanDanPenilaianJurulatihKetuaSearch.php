...
/**
 * PengurusanPemantauanDanPenilaianJurulatihKetuaSearch represents the model behind the search form about `app\models\PengurusanPemantauanDanPenilaianJurulatihKetua`.
 */
class PengurusanPemantauanDanPenilaianJurulatihKetuaSearch extends PengurusanPemantauanDanPenilaianJurulatihKetua
{
    public $jurulatih;
    ...
    {
        $query = PengurusanPemantauanDanPenilaianJurulatihKetua::find()
        ...
        if(isset(Yii::$app->user->identity->peranan_akses['MSN']['pengurusan-pemantauan-dan-penilaian-jurulatih-ketua']['view_own_data'])){
            $query->andFilterWhere(['tbl_pengurusan_pemantauan_dan_penilaian_jurulatih_ketua.created_by'=>Yii::$app->user->identity->id]);
        }
        ...
        if(Yii::$app->user->identity->sukan){
            ...
            for($i = 0; $i < count($sukan_access); $i++){
                $arr_sukan = null;
                $arr_sukan = array('tbl_pengurusan_pemantauan_dan_penilaian_jurulatih_ketua.nama_sukan'=>$sukan_access[$i]); 
                    array_push($arr_sukan_filter,$arr_sukan);
            }
            
            $query->andFilterWhere(['tbl_pengurusan_pemantauan_dan_penilaian_jurulatih_ketua.nama_sukan'=>$arr_sukan_filter]);
            
            $query->orFilterWhere(['tbl_pengurusan_pemantauan_dan_penilaian_jurulatih_ketua.created_by'=>Yii::$app->user->identity->id]);
        }
