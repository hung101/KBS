...
class ProfilBadanSukan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['no_telefon_pejabat', 'no_telefon_pejabat_2', 'no_telefon_pejabat_3', 'no_tel_bimbit', 'no_faks_pejabat', 'alamat_tetap_badan_sukan_poskod', 'alamat_surat_menyurat_badan_sukan_poskod'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
