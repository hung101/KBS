...
/**
 * BantuanPenganjuranKejohananBayaranSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananBayaran`.
 */
class BantuanPenganjuranKejohananBayaranSearch extends BantuanPenganjuranKejohananBayaran
{
    /**
     * @inheritdoc
     */
