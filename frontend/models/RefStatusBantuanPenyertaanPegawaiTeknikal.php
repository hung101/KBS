...
/**
 * This is the model class for table "tbl_ref_status_bantuan_penyertaan_pegawai_teknikal".
 *
 * @property integer $id
 ...
 */
class RefStatusBantuanPenyertaanPegawaiTeknikal extends \yii\db\ActiveRecord
{
    const LULUS = 1;
    ...
    {
        return 'tbl_ref_status_bantuan_penyertaan_pegawai_teknikal';
    }
