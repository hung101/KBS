...
/**
 * PublicUserELaporanSearch represents the model behind the search form about `app\models\User`.
 */
class PublicUserELaporanSearch extends PublicUserELaporan
{
    public $nama_peranan;
