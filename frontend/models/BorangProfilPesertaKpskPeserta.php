...
class BorangProfilPesertaKpskPeserta extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nama', 'no_kad_pengenalan', 'tarikh_lahir', 'jantina', 'bangsa', 'agama', 'alamat_1', 'alamat_negeri', 'alamat_poskod',
    ...
    public function attributeLabels()
    {
        return [
			...
			'laporan_projek' => GeneralLabel::laporan_projek,
			'penilaian_refleksi' => GeneralLabel::penilaian_refleksi,
