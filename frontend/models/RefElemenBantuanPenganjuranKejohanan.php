...
/**
 * This is the model class for table "tbl_ref_elemen_bantuan_penganjuran_kejohanan".
 *
 * @property integer $id
 ...
 */
class RefElemenBantuanPenganjuranKejohanan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_elemen_bantuan_penganjuran_kejohanan';
    }
