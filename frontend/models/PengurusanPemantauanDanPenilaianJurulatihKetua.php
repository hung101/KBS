 ...
 */
class PengurusanPemantauanDanPenilaianJurulatihKetua extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_pengurusan_pemantauan_dan_penilaian_jurulatih_ketua';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['tarikh_hantar'], 'safe'],
            [['nama_jurulatih_dinilai', 'pusat_latihan'], function ($attribute, $params) {
