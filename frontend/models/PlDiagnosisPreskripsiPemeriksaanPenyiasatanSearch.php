...
/**
 * PlDiagnosisPreskripsiPemeriksaanPenyiasatanSearch represents the model behind the search form about `app\models\PlDiagnosisPreskripsiPemeriksaanPenyiasatan`.
 */
class PlDiagnosisPreskripsiPemeriksaanPenyiasatanSearch extends PlDiagnosisPreskripsiPemeriksaanPenyiasatan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PlDiagnosisPreskripsiPemeriksaanPenyiasatan::find()
