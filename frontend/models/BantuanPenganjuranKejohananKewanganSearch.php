...
/**
 * BantuanPenganjuranKejohananKewanganSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananKewangan`.
 */
class BantuanPenganjuranKejohananKewanganSearch extends BantuanPenganjuranKejohananKewangan
{
    /**
     * @inheritdoc
     */
