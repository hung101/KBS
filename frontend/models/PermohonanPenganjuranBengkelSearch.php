...
/**
 * PermohonanPenganjuranBengkelSearch represents the model behind the search form about `app\models\PermohonanPenganjuranBengkel`.
 */
class PermohonanPenganjuranBengkelSearch extends PermohonanPenganjuranBengkel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['permohonan_penganjuran_bengkel_id', 'bil_penceramah', 'bil_peserta', 'bil_urusetia', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        $query = PermohonanPenganjuranBengkel::find()
        ...
        $query->andFilterWhere([
            'permohonan_penganjuran_bengkel_id' => $this->permohonan_penganjuran_bengkel_id,
            'tarikh' => $this->tarikh,
