...
class PlTemujanji extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['doktor_pegawai_perubatan', 'makmal_perubatan', 'pegawai_yang_bertanggungjawab','status_temujanji','catitan_ringkas', 'catatan_tambahan'], 'filter', 'filter' => function ($value) {
