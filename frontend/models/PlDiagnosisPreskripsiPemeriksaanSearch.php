...
/**
 * PlDiagnosisPreskripsiPemeriksaanSearch represents the model behind the search form about `app\models\PlDiagnosisPreskripsiPemeriksaan`.
 */
class PlDiagnosisPreskripsiPemeriksaanSearch extends PlDiagnosisPreskripsiPemeriksaan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PlDiagnosisPreskripsiPemeriksaan::find()
