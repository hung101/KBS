...
class PermohonanPendidikan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tahun_program', 'jenis_permohonan', 'tarikh_permohonan'], 'safe'],
            ...
            [['alamat_rumah_negeri', 'tahap_pendidikan', 'alamat_pendidikan_negeri', 'kategori_atlet'], 'string', 'max' => 30, 'tooLong' => GeneralMessage::yii_validation_string_max],
            ...
            [['nama_ibu_bapa_penjaga', 'aliran', 'pilihan_aliran_spm', 'sukan', 'acara', 'nama_pencadang', 'jawatan_pencadang', 
