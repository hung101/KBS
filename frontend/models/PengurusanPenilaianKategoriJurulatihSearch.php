...
/**
 * PengurusanPenilaianKategoriJurulatihSearch represents the model behind the search form about `app\models\PengurusanPenilaianKategoriJurulatih`.
 */
class PengurusanPenilaianKategoriJurulatihSearch extends PengurusanPenilaianKategoriJurulatih
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PengurusanPenilaianKategoriJurulatih::find()
