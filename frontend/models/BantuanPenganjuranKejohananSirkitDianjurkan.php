 ...
 */
class BantuanPenganjuranKejohananSirkitDianjurkan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_bantuan_penganjuran_kejohanan_sirkit_dianjurkan';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'peringkat_penganjuran' => GeneralLabel::peringkat,  //'Peringkat Penganjuran',
            'jumlah' => GeneralLabel::jumlah,  //'Jumlah (RM)',
            'peringkat_penganjuran_lain' => GeneralLabel::nyatakan_jika_lain_lain,  //'Nyatakan (Jika Lain-lain)',
