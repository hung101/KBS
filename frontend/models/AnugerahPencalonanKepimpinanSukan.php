...
class AnugerahPencalonanKepimpinanSukan extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sumbangan_dalam_pencapaian' => GeneralLabel::sumbangan_dalam_pencapaian,  //'Sumbangan Dalam Aspek Kepimpinan, Pengurusan Dan Perkhidmatan Yang Cemerlang Untuk Kemajuan Sukan Negara',
