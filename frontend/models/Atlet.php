...
class Atlet extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        ...
        if(isset($session['atlet_cacat']) && $session['atlet_cacat']){
            return [
                ...
                [['name_penuh', 'nama_kecemasan', 'jenis_kecederaan', 'bilangan_jkk_jkp'], 'string', 'max' => 80, 'tooLong' => GeneralMessage::yii_validation_string_max],
                ...
                [['tel_bimbit_no_1', 'tel_bimbit_no_2', 'tel_no', 'tel_no_kecemasan', 'tel_bimbit_no_kecemasan'], 'string', 'max' => 14, 'tooLong' => GeneralMessage::yii_validation_string_max],
                            [['tel_bimbit_no_1', 'tel_bimbit_no_2', 'tel_no', 'tel_no_kecemasan', 'tel_bimbit_no_kecemasan'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tawaran_atlet' => GeneralLabel::tawaran_atlet,
        ];
    }
