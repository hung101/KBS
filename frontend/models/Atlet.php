    ...
    public function rules()
    {
        return [
            [['tahap', 'tid', 'cawangan', 'name_penuh', 'tarikh_lahir', 'umur', 'tempat_lahir_bandar', 'tempat_lahir_negeri', 
                ...
                'nama_kecemasan', 'pertalian_kecemasan', 'tel_no_kecemasan', 'tel_bimbit_no_kecemasan'], 'required', 'skipOnEmpty' => true],
            [['tarikh_lahir', 'lesen_tamat_tempoh', 'passport_tamat_tempoh'], 'safe'],
            [['umur', 'tel_bimbit_no_1', 'tel_bimbit_no_2', 'tel_no', 'tid', 'tel_no_kecemasan', 'tel_bimbit_no_kecemasan'], 'integer'],
            [['tinggi', 'berat'], 'number'],
            [['lesen_memandu_no', 'dari_bahagian', 'sumber', 'pertalian_kecemasan'], 'string', 'max' => 20],
            [['name_penuh', 'nama_kecemasan'], 'string', 'max' => 80],
            [['tempat_lahir_bandar', 'alamat_rumah_bandar', 'alamat_surat_bandar'], 'string', 'max' => 30],
            [['tempat_lahir_negeri', 'alamat_rumah_negeri', 'alamat_surat_negeri', 'passport_tempat_dikeluarkan', 'negeri_diwakili'], 'string', 'max' => 40],
            [['bangsa', 'bahasa_ibu'], 'string', 'max' => 25],
            [['agama', 'taraf_perkahwinan', 'no_sijil_lahir', 'passport_no'], 'string', 'max' => 15],
            [['jantina'], 'string', 'max' => 1],
            [['ic_no', 'ic_tentera'], 'string', 'max' => 12],
            [['alamat_rumah_poskod', 'alamat_surat_poskod'], 'string', 'max' => 5],
            [['ic_no_lama'], 'string', 'max' => 8],
            [['jenis_lesen', 'emel', 'facebook', 'twitter'], 'string', 'max' => 100],
            [['alamat_rumah_1','alamat_rumah_2','alamat_rumah_3', 'alamat_surat_menyurat_1', 'alamat_surat_menyurat_2', 'alamat_surat_menyurat_3'], 'string', 'max' => 90],
            [['file'], 'safe'],
