 ...
 *
 * @property integer $bantuan_penganjuran_kursus_penceramah_id
 ...
 */
class BantuanPenganjuranKursusPenceramah extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_bantuan_penganjuran_kursus_penceramah';
    }
    ...
    {
        return [
            'bantuan_penganjuran_kursus_penceramah_id' => 'Bantuan Penganjuran Kursus Penceramah ID',
