...
/**
 * BantuanPenganjuranKejohananDianjurkanSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananDianjurkan`.
 */
class BantuanPenganjuranKejohananDianjurkanSearch extends BantuanPenganjuranKejohananDianjurkan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = BantuanPenganjuranKejohananDianjurkan::find();
