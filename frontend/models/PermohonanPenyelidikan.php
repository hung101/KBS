...
class PermohonanPenyelidikan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['biasa_dengan_keperluan_penyelidikan', 'kelulusan_echics', 'kelulusan', 'jenis_projek', 'akademik_jenis_perkhidmatan', 'akademik_kursus', 'pengisytiharan'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
            [['nama_permohon', 'tajuk_penyelidikan', 'akademik_nama', 'akademik_nama_yang_dicadangkan'], 'string', 'max' => 80, 'tooLong' => GeneralMessage::yii_validation_string_max],
            [['ringkasan_permohonan', 'pengecualian_persetujuan', 'sebab_tiada_penyertaan_lembaran_maklumat', 'sebab_tiada_borang_persetujuan_penyertaan'], 'string', 'max' => 255, 'tooLong' => GeneralMessage::yii_validation_string_max],
