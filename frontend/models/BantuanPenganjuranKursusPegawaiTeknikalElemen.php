 ...
 * @property integer $bantuan_penganjuran_kursus_pegawai_teknikal_elemen_id
 ...
 */
class BantuanPenganjuranKursusPegawaiTeknikalElemen extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_bantuan_penganjuran_kursus_pegawai_teknikal_elemen';
    }
    ...
    {
        return [
            [['bantuan_penganjuran_kursus_pegawai_teknikal_elemen_id', 'bilangan', 'hari', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        return [
            'bantuan_penganjuran_kursus_pegawai_teknikal_elemen_id' => 'Bantuan Penganjuran Kejohanan Elemen ID',
            'bantuan_penganjuran_kursus_pegawai_teknikal_id' => 'Bantuan Penganjuran Kejohanan ID',
