...
/**
 * AnugerahPencalonanKepimpinanSukanSearch represents the model behind the search form about `app\models\AnugerahPencalonanKepimpinanSukan`.
 */
class AnugerahPencalonanKepimpinanSukanSearch extends AnugerahPencalonanKepimpinanSukan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AnugerahPencalonanKepimpinanSukan::find()
