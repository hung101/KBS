...
/**
 * AnugerahPencalonanLainJawatanSearch represents the model behind the search form about `app\models\AnugerahPencalonanLainJawatan`.
 */
class AnugerahPencalonanLainJawatanSearch extends AnugerahPencalonanLainJawatan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AnugerahPencalonanLainJawatan::find();
