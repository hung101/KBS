...
/**
 * BantuanPenyertaanPegawaiTeknikalDicadangkanSearch represents the model behind the search form about `app\models\BantuanPenyertaanPegawaiTeknikalDicadangkan`.
 */
class BantuanPenyertaanPegawaiTeknikalDicadangkanSearch extends BantuanPenyertaanPegawaiTeknikalDicadangkan
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['bantuan_penyertaan_pegawai_teknikal_dicadangkan_id', 'bantuan_penyertaan_pegawai_teknikal_id', 'umur', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        $query = BantuanPenyertaanPegawaiTeknikalDicadangkan::find();
