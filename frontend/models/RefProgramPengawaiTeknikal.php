...
/**
 * This is the model class for table "tbl_ref_program_pengawai_teknikal".
 *
 * @property integer $id
 ...
 */
class RefProgramPengawaiTeknikal extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_program_pengawai_teknikal';
    }
