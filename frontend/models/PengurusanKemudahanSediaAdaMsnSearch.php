...
/**
 * PengurusanKemudahanSediaAdaMsnSearch represents the model behind the search form about `app\models\PengurusanKemudahanSediaAdaMsn`.
 */
class PengurusanKemudahanSediaAdaMsnSearch extends PengurusanKemudahanSediaAdaMsn
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['keluasan_padang', 'nama_kemudahan', 'size', 'session_id', 'jenis_kemudahan', 'sukan_rekreasi'], 'safe'],
    ...
    {
        $query = PengurusanKemudahanSediaAdaMsn::find()
                ->joinWith(['refPengurusanVenue'])
                ->joinWith(['refJenisKemudahan'])
                ->joinWith(['refSukanRekreasi']);
        ...
        $query->andFilterWhere(['like', 'keluasan_padang', $this->keluasan_padang])
                ...
                ->andFilterWhere(['like', 'tbl_ref_sukan_rekreasi.desc', $this->sukan_rekreasi]);
