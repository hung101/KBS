 ...
 */
class PengurusanKemudahanSediaAdaMsn extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_pengurusan_kemudahan_sedia_ada_msn';
    }
    ...
    public function rules()
    {
        return [
            [['lokasi', 'jenis_kemudahan', 'pengurusan_kemudahan_venue_id','kadar_sewaan_sejam_siang','kadar_sewaan_sehari_siang','kadar_sewaan_seminggu_siang','kadar_sewaan_sebulan_siang',
                ...
                'kadar_sewaan_sejam_siang_cuti_umum','kadar_sewaan_sehari_siang_cuti_umum','kadar_sewaan_seminggu_siang_cuti_umum','kadar_sewaan_sebulan_siang_cuti_umum',
                'kadar_sewaan_sejam_malam_cuti_umum','kadar_sewaan_sehari_malam_cuti_umum','kadar_sewaan_seminggu_malam_cuti_umum','kadar_sewaan_sebulan_malam_cuti_umum', 
                'sukan_rekreasi', 'agensi'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required],
            ...
            [['cost_pembaikian','kadar_sewaan_sejam_siang','kadar_sewaan_sehari_siang','kadar_sewaan_seminggu_siang',
                ...
                'kadar_sewaan_sebulan_malam','kadar_sewaan_sejam_siang_cuti_umum','kadar_sewaan_sehari_siang_cuti_umum','kadar_sewaan_seminggu_siang_cuti_umum',
            ...
            [['keluasan_padang', 'size','lokasi'], function ($attribute, $params) {
