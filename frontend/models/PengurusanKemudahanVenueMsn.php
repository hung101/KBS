...
class PengurusanKemudahanVenueMsn extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_venue', 'pemilik', 'sewaan','alamat_1', 'alamat_2', 'alamat_3','alamat_negeri', 'status','alamat_bandar','keluasan_venue','emel'], function ($attribute, $params) {
    ...
    public function getNameAndState(){
        ...
        if(isset($this->nama_venue)){
            $returnValue .= $this->nama_venue;
        }
