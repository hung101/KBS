...
/**
 * This is the model class for table "tbl_ref_kelulusan_geran_bantuan_gaji_jurulatih".
 *
 * @property integer $id
 ...
 */
class RefKelulusanGeranBantuanGajiJurulatih extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_kelulusan_geran_bantuan_gaji_jurulatih';
    }
