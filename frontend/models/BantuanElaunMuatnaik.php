 ...
 *
 * @property integer $bantuan_elaun_muatnaik_id
 * @property string $butiran_permohonan
 * @property string $amaun
 * @property string $muatnaik_dokumen
 */
class BantuanElaunMuatnaik extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_bantuan_elaun_muatnaik';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['butiran_permohonan'], 'filter', 'filter' => function ($value) {
