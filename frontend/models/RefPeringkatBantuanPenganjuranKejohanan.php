...
/**
 * This is the model class for table "tbl_ref_peringkat_bantuan_penganjuran_kejohanan".
 *
 * @property integer $id
 ...
 */
class RefPeringkatBantuanPenganjuranKejohanan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_peringkat_bantuan_penganjuran_kejohanan';
    }
