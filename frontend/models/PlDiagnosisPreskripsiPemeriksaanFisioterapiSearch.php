...
/**
 * PlDiagnosisPreskripsiPemeriksaanFisioterapiSearch represents the model behind the search form about `app\models\PlDiagnosisPreskripsiPemeriksaanFisioterapi`.
 */
class PlDiagnosisPreskripsiPemeriksaanFisioterapiSearch extends PlDiagnosisPreskripsiPemeriksaanFisioterapi
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['jenis_diagnosis_preskripsi_pemeriksaan', 'status_diagnosis_preskripsi_pemeriksaan', 'catitan_ringkas', 'session_id', 'bahagian_kecederaan', 'rawatan_fisioterapi'], 'safe'],
        ];
    }
    ...
    {
        $query = PlDiagnosisPreskripsiPemeriksaanFisioterapi::find()
                ...
                ->joinWith(['refRawatanFisioterapi']);
        ...
        $query->andFilterWhere(['like', 'tbl_ref_jenis_kecederaan_masalah_kesihatan.desc', $this->jenis_diagnosis_preskripsi_pemeriksaan])
            ->andFilterWhere(['like', 'tbl_ref_status_diagnosis_preskripsi_pemeriksaan_penyiasatan.desc', $this->status_diagnosis_preskripsi_pemeriksaan])
                ...
                ->andFilterWhere(['like', 'tbl_ref_rawatan_fisioterapi.desc', $this->rawatan_fisioterapi])
