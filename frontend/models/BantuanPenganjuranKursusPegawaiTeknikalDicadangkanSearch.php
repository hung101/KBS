...
/**
 * BantuanPenganjuranKursusPegawaiTeknikalDicadangkanSearch represents the model behind the search form about `app\models\BantuanPenganjuranKursusPegawaiTeknikalDicadangkan`.
 */
class BantuanPenganjuranKursusPegawaiTeknikalDicadangkanSearch extends BantuanPenganjuranKursusPegawaiTeknikalDicadangkan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = BantuanPenganjuranKursusPegawaiTeknikalDicadangkan::find();
