 ...
 */
class AnugerahPencalonanTokohSukan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_anugerah_pencalonan_tokoh_sukan';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['kategori','nama','sumbangan_dalam_pencapaian', 'ulasan_justifikasi'], function ($attribute, $params) {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sumbangan_dalam_pencapaian' => GeneralLabel::sumbangan_dalam_pencapaian,  //'Jasa Dan Sumbangan Yang Sentiasa Menjadi Inspirasi Dalam Pembangunan Dan Kemajuan Sukan Negara',
