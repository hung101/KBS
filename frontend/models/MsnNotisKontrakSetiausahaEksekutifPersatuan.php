...
class MsnNotisKontrakSetiausahaEksekutifPersatuan extends Model
{
    public $tarikh_dari;
    ...
    public $negeri;
    public $persatuan;
    public $no_rujukan_fail;
    public $tarikh_keluarkan_surat;
    public $tarikh_lantikan;
    public $tarikh_tamat_maklumbalas_notis_kontrak;
    public $format;
