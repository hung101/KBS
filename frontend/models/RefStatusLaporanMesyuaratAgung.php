...
/**
 * This is the model class for table "tbl_ref_status_laporan_mesyuarat_agung".
 *
 * @property integer $id
 ...
 */
class RefStatusLaporanMesyuaratAgung extends \yii\db\ActiveRecord
{
    const BELUM_DISAHKAN = 1;
    const DISAHKAN = 2;
    const QUERY = 3;
