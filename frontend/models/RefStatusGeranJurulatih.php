...
/**
 * This is the model class for table "tbl_ref_status_geran_jurulatih".
 *
 * @property integer $id
 ...
 */
class RefStatusGeranJurulatih extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_status_geran_jurulatih';
    }
