...
class RefPenilaianJurulatih extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['desc', 'markah_peratus'], 'required', 'message' => GeneralMessage::yii_validation_required],
            [['aktif', 'created_by', 'updated_by'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
            [['markah_peratus'], 'number', 'message' => GeneralMessage::yii_validation_number],
            [['created', 'updated'], 'safe'],
            [['desc'], 'string', 'max' => 80, 'tooLong' => GeneralMessage::yii_validation_string_max],
            [['markah_peratus'], 'string', 'max' => 10, 'tooLong' => GeneralMessage::yii_validation_string_max],
            [['desc','markah_peratus'], 'filter', 'filter' => function ($value) {
    ...
    {
        return [
            'markah_peratus' => GeneralLabel::markah_peratus,
            'id' => GeneralLabel::id,
