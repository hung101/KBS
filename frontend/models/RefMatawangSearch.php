...
/**
 * RefMatawangSearch represents the model behind the search form about `app\models\RefMatawang`.
 */
class RefMatawangSearch extends RefMatawang
{
    /**
     * @inheritdoc
     */
