...
class MsnLaporanProfilAhliJawatankuasaKhasSukanMalaysia extends Model
{
    public $tarikh_dari;
    ...
    public function rules()
    {
        return [
            ...
            [['tarikh_dari', 'tarikh_hingga', 'temasya', 'jawatankuasa'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'jawatankuasa' => GeneralLabel::jawatankuasa,
