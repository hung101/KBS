...
/**
 * This is the model class for table "tbl_ref_kategori_pelan".
 *
 * @property integer $id
 ...
 */
class RefKategoriPelan extends \yii\db\ActiveRecord
{
    const KEJOHANAN_LATIHAN = 1;
