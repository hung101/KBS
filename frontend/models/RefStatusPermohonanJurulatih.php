...
/**
 * This is the model class for table "tbl_ref_status_permohonan_jurulatih".
 *
 * @property integer $id
 ...
 */
class RefStatusPermohonanJurulatih extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_status_permohonan_jurulatih';
    }
