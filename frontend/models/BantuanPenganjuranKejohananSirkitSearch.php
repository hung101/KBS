...
/**
 * BantuanPenganjuranKejohananSirkitSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananSirkit`.
 */
class BantuanPenganjuranKejohananSirkitSearch extends BantuanPenganjuranKejohananSirkit
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['badan_sukan', 'sukan', 'no_pendaftaran', 'alamat_1', 'alamat_2', 'alamat_3', 'alamat_negeri', 'alamat_bandar', 'alamat_poskod', 'no_telefon', 'no_faks', 'laman_sesawang', 
                ...
                'permohonan_rasmi_dari_ahli_gabungan', 'maklumat_lain_sokongan', 'status_permohonan', 'catatan', 'tarikh_permohonan', 
                'jkb', 'tarikh_jkb', 'created', 'updated', 'negeri_penyertaan'], 'safe'],
    ...
    {
        $query = BantuanPenganjuranKejohananSirkit::find()
