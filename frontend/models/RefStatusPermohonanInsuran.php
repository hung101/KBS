...
/**
 * This is the model class for table "tbl_ref_status_permohonan_insuran".
 *
 * @property integer $id
 ...
 */
class RefStatusPermohonanInsuran extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_status_permohonan_insuran';
    }
