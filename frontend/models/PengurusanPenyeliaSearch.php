...
/**
 * PengurusanPenyeliaSearch represents the model behind the search form about `app\models\PengurusanPenyelia`.
 */
class PengurusanPenyeliaSearch extends PengurusanPenyelia
{
    public $nama_peranan;
