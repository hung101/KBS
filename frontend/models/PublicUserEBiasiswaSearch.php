...
use app\models\PublicUserEBiasiswa;

/**
 * PublicUserEBiasiswaSearch represents the model behind the search form about `app\models\User`.
 */
class PublicUserEBiasiswaSearch extends PublicUserEBiasiswa
{
    public $nama_peranan;
    ...
    {
        $query = PublicUserEBiasiswa::find();
