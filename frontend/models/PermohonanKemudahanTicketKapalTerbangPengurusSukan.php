...
class PermohonanKemudahanTicketKapalTerbangPengurusSukan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pengurus_sukan', 'passport_no', 'ic_no', 'hp_no', 'tarikh_pergi', 'tarikh_balik', 'destinasi_pergi', 'destinasi_balik'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required],
