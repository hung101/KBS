...
class PermohonanKemudahanTicketKapalTerbangPengurusSukan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['pengurus_sukan','hp_no', 'masa_pergi', 'masa_balik','flight_no_pergi', 'flight_no_balik', 'passport_no', 'ic_no','destinasi_pergi', 'destinasi_balik', 'catatan'], 'filter', 'filter' => function ($value) {
