...
/**
 * This is the model class for table "tbl_pengurusan_program_binaan_urusetia".
 *
 * @property integer $pengurusan_program_binaan_urusetia_id
 * @property integer $pengurusan_program_binaan_id
 * @property string $nama
 * @property string $jantina
 */
class PengurusanProgramBinaanUrusetia extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_pengurusan_program_binaan_urusetia';
    }
    ...
    {
        return [
            'pengurusan_program_binaan_urusetia_id' => GeneralLabel::id,
