...
/**
 * AnugerahPencalonanLainearch represents the model behind the search form about `app\models\AnugerahPencalonanLain`.
 */
class AnugerahPencalonanLainearch extends AnugerahPencalonanLain
{
    /**
     * @inheritdoc
     */
