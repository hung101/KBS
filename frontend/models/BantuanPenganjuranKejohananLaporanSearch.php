...
/**
 * BantuanPenganjuranKejohananLaporanSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananLaporan`.
 */
class BantuanPenganjuranKejohananLaporanSearch extends BantuanPenganjuranKejohananLaporan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = BantuanPenganjuranKejohananLaporan::find();
