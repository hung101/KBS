...
/**
 * This is the model class for table "tbl_ref_kategori_penganjuran".
 *
 * @property integer $id
 ...
 */
class RefKategoriPenganjuran extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_kategori_penganjuran';
    }
