...
/**
 * RefSekolahInstitusiSearch represents the model behind the search form about `app\models\RefSekolahInstitusi`.
 */
class RefSekolahInstitusiSearch extends RefSekolahInstitusi
{
    /**
     * @inheritdoc
     */
