...
/**
 * This is the model class for table "tbl_ref_status_khidmat_perubatan".
 *
 * @property integer $id
 ...
 */
class RefStatusKhidmatPerubatan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_status_khidmat_perubatan';
    }
