...
/**
 * PenilaianPesertaTerhadapKursusSearch represents the model behind the search form about `app\models\PenilaianPesertaTerhadapKursus`.
 */
class PenilaianPesertaTerhadapKursusSearch extends PenilaianPesertaTerhadapKursus
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['penilaian_peserta_terhadap_kursus_id', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        $query = PenilaianPesertaTerhadapKursus::find()
        ...
        $query->andFilterWhere(['like', 'nama_penganjur_kursus', $this->nama_penganjur_kursus])
            ->andFilterWhere(['like', 'tbl_penilaian_peserta_terhadap_kursus.kod_kursus', $this->kod_kursus])
            ->andFilterWhere(['like', 'tempat_kursus', $this->tempat_kursus])
                ->andFilterWhere(['like', 'tbl_penilaian_peserta_terhadap_kursus.tarikh_kursus', $this->tarikh_kursus])
