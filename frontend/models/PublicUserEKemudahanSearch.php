...
/**
 * PublicUserEKemudahanSearch represents the model behind the search form about `app\models\User`.
 */
class PublicUserEKemudahanSearch extends PublicUserEKemudahan
{
    public $nama_peranan;
    ...
    {
        $query = PublicUserEKemudahan::find();
