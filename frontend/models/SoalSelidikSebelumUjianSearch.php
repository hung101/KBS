...
/**
 * SoalSelidikSebelumUjianSearch represents the model behind the search form about `app\models\SoalSelidikSebelumUjian`.
 */
class SoalSelidikSebelumUjianSearch extends SoalSelidikSebelumUjian
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = SoalSelidikSebelumUjian::find()
                ->joinWith(['refAtlet'])
