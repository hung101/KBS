...
/**
 * This is the model class for table "tbl_ref_kategori_oku_e_biasiswa".
 *
 * @property integer $id
 ...
 */
class RefKategoriOkuEBiasiswa extends \yii\db\ActiveRecord
{
    const OKU_LAIN_LAIN = '5';
    ...
    {
        return 'tbl_ref_kategori_oku_e_biasiswa';
    }
