...
/**
 * BantuanPenganjuranKejohananSirkitElemenSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananSirkitElemen`.
 */
class BantuanPenganjuranKejohananSirkitElemenSearch extends BantuanPenganjuranKejohananSirkitElemen
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = BantuanPenganjuranKejohananSirkitElemen::find()
