 ...
 */
class ProfilPpn extends \yii\db\ActiveRecord
{
    public $new_password;
    ...
    {
        return [
            [['username', 'peranan', 'full_name', 'status', 'ppn_sukan', 'ppn_negeri', 'ppn_kategori_jawatan', 'email'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required ],
            ...
            [['aduan_venue', 'aduan_bahagian', 'aduan_kawasan_kemudahan', 'ppn_sukan', 'ppn_negeri'], 'safe'],
            ...
            [['email', 'full_name','aduan_jawatan','aduan_venue', 'aduan_bahagian', 'aduan_kawasan_kemudahan', 'ppn_sukan', 'ppn_negeri'], 'filter', 'filter' => function ($value) {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ppn_sukan' => GeneralLabel::sukan,
            'ppn_negeri' => GeneralLabel::negeri,
            'ppn_kategori_jawatan' => GeneralLabel::kategori_jawatan,
        ];
    }
    ...
    public function getRefNegeriPpn()
    {
        return $this->hasOne(RefNegeri::className(), ['id' => 'ppn_negeri']);
    }
    
    public function getRefSukanPpn()
    {
        return $this->hasOne(RefSukan::className(), ['id' => 'ppn_sukan']);
    }
}
