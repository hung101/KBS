...
class InformasiPersatuan extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nama_persatuan', 'alamat_1', 'alamat_negeri', 'alamat_poskod', 'no_tel', 'no_faks'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required],
            ...
            [['nama_persatuan','alamat_1', 'alamat_2', 'alamat_3','alamat_negeri','alamat_bandar','alamat_poskod','emel', 'laman_web'], function ($attribute, $params) {
