...
/**
 * AnugerahPencalonanLainSearch represents the model behind the search form about `app\models\AnugerahPencalonanLain`.
 */
class AnugerahPencalonanLainSearch extends AnugerahPencalonanLain
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AnugerahPencalonanLain::find()
