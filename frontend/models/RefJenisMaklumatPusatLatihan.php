...
/**
 * This is the model class for table "tbl_ref_jenis_maklumat_pusat_latihan".
 *
 * @property integer $id
 ...
 */
class RefJenisMaklumatPusatLatihan extends \yii\db\ActiveRecord
{
    const PERMOHONAN = 1;
    const MAKLUMAT = 2;
    ...
    {
        return 'tbl_ref_jenis_maklumat_pusat_latihan';
    }
