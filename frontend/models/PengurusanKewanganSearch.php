...
/**
 * PengurusanKewanganSearch represents the model behind the search form about `app\models\PengurusanKewangan`.
 */
class PengurusanKewanganSearch extends PengurusanKewangan
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'tbl_ref_sukan.desc', $this->nama_acara_program])
            ...
            ->andFilterWhere(['like', 'tbl_ref_kategori_penggunaan.desc', $this->kategori_penggunaan])
