...
/**
 * This is the model class for table "tbl_ref_jenis_program_jaringan_antarabangsa".
 *
 * @property integer $id
 ...
 */
class RefJenisProgramJaringanAntarabangsa extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_jenis_program_jaringan_antarabangsa';
    }
