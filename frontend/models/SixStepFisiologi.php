 ...
 */
class SixStepFisiologi extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['stage', 'status'], 'filter', 'filter' => function ($value) {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getRefSixstepFisiologiStage(){
        return $this->hasOne(RefSixstepFisiologiStage::className(), ['id' => 'stage']);
    }
    
    /**
     * @return \yii\db\ActiveQuery
     */
    public function getRefSixstepFisiologiStatus(){
        return $this->hasOne(RefSixstepFisiologiStatus::className(), ['id' => 'status']);
    }
}
