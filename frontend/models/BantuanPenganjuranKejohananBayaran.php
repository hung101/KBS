...
class BantuanPenganjuranKejohananBayaran extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['jenis_bayaran','lain_lain'], function ($attribute, $params) {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'jenis_bayaran' => GeneralLabel::jenis_bayaran,  //'Jenis Bayaran',
            'lain_lain' => GeneralLabel::lain_lain,  //'Nyatakan (Jika Lain-lain)',
