...
class MaklumatPegawaiTeknikal extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['badan_sukan', 'sukan', 'jawatan_pengawai', 'kategori', 'program', 'nama', 'alamat_1', 'alamat_negeri', 'alamat_bandar', 'alamat_poskod', 'no_kad_pengenalan', 'umur', 'jantina', 
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tahap_kelayakan_sukan_peringkat_kebangsaan' => 'Tahap Teknikal / Kepegaiwaian Kelayakan (Kebangsaan)',
            'tahap_kelayakan_sukan_peringkat_antarabangsa' => 'Tahap Kelayakan Teknikal / Kepegaiwaian (Antarabangsa)',
