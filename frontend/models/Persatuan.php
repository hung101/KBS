 ...
 */
class Persatuan extends \yii\db\ActiveRecord
{
    public $new_password;
    ...
    {
        return [
            [['username', 'peranan', 'full_name', 'status', 'ipt_bendahari_e_biasiswa', 'profil_badan_sukan'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required],
            ...
            [['username','full_name','email','sukan'], function ($attribute, $params) {
    ...
    public function getRefProfilBadanSukan(){
        return $this->hasOne(ProfilBadanSukan::className(), ['profil_badan_sukan' => 'profil_badan_sukan']);
    }
}
