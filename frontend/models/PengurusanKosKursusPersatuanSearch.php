...
/**
 * PengurusanKosKursusPersatuanSearch represents the model behind the search form about `app\models\PengurusanKosKursusPersatuan`.
 */
class PengurusanKosKursusPersatuanSearch extends PengurusanKosKursusPersatuan
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['pengurusan_perhimpunan_kem_kos_id', 'kursus_persatuan_id'], 'integer'],
    ...
    {
        $query = PengurusanKosKursusPersatuan::find()
