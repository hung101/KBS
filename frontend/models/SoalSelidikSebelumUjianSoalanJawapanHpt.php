 ...
 */
class SoalSelidikSebelumUjianSoalanJawapanHpt extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_soal_selidik_sebelum_ujian_soalan_jawapan_hpt';
    }
    ...
    public function getRefSoalanSoalSelidik(){
        return $this->hasOne(RefSoalanSoalSelidikHpt::className(), ['id' => 'soalan']);
    }
    ...
    public function getRefJawapanSoalSelidik(){
        return $this->hasOne(RefJawapanSoalSelidikHpt::className(), ['id' => 'jawapan']);
    }
}
