...
class AtletKarier extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['atlet_id', 'syarikat', 'jawatan_kerja', 'pendapatan', 'tahun_mula', 'alamat_1', 'alamat_negeri', 'alamat_poskod', 'tel_no'], 'required', 'skipOnEmpty' => true, 'message' => GeneralMessage::yii_validation_required],
