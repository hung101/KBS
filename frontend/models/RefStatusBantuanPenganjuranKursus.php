...
/**
 * This is the model class for table "tbl_ref_status_bantuan_penganjuran_kursus".
 *
 * @property integer $id
 ...
 */
class RefStatusBantuanPenganjuranKursus extends \yii\db\ActiveRecord
{
    const LULUS = 1;
    ...
    {
        return 'tbl_ref_status_bantuan_penganjuran_kursus';
    }
