...
/**
 * This is the model class for table "tbl_ref_kelulusan_hq_e_bantuan".
 *
 * @property integer $id
 ...
 */
class RefKelulusanHqEBantuan extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_ref_kelulusan_hq_e_bantuan';
    }
