...
/**
 * PermohonanEBantuanUrusetiaSearch represents the model behind the search form about `app\models\PermohonanEBantuanUrusetia`.
 */
class PermohonanEBantuanUrusetiaSearch extends PermohonanEBantuanUrusetia
{
    public $nama_peranan;
    ...
    {
        $query = PermohonanEBantuanUrusetia::find()
