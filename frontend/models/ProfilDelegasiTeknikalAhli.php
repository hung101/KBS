...
class ProfilDelegasiTeknikalAhli extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['no_telefon_bimbit','no_telefon_pejabat'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tarikh_lahir' => GeneralLabel::tarikh_lahir,  //'Tarikh Lahir',
            ...
            'no_telefon_bimbit' => GeneralLabel::no_telefon_bimbit,  //'No Telefon Bimbit',
            'emel' => GeneralLabel::emel,  //'E-mel',
            'pekerjaan' => GeneralLabel::pekerjaan,  //'Pekerjaan',
