...
/**
 * BantuanPenganjuranKejohananOlehMsnSearch represents the model behind the search form about `app\models\BantuanPenganjuranKejohananOlehMsn`.
 */
class BantuanPenganjuranKejohananOlehMsnSearch extends BantuanPenganjuranKejohananOlehMsn
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = BantuanPenganjuranKejohananOlehMsn::find();
