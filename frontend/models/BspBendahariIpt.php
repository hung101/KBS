...
class BspBendahariIpt extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['jabatan_id', 'peranan', 'status', 'profil_badan_sukan', 'ipt_bendahari_e_biasiswa', 'no_kad_pengenalan', 'tel_mobile_no', 'tel_no'], 'integer', 'message' => GeneralMessage::yii_validation_integer ],
