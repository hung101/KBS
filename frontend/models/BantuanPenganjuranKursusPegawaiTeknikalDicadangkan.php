...
/**
 * This is the model class for table "tbl_bantuan_penganjuran_kursus_pegawai_teknikal_dicadangkan".
 *
 ...
 */
class BantuanPenganjuranKursusPegawaiTeknikalDicadangkan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_bantuan_penganjuran_kursus_pegawai_teknikal_dicadangkan';
    }
    ...
    {
        return [
            [['bantuan_penganjuran_kursus_pegawai_teknikal_dicadangkan_id', 'umur', 'created_by', 'updated_by', 'no_kad_pengenalan',
            ...
            [['alamat_e_mail','badan_sukan', 'nama_majikan', 'jawatan','alamat_negeri','sukan', 'nama', 'alamat_1', 'alamat_2', 'alamat_3', 'no_passport', 'tahap_akademik',
                'alamat_bandar', 'alamat_poskod','nama_kejohanan_kursus','tempat','gred'], 'filter', 'filter' => function ($value) {
