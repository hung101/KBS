...
class RefSubKategoriPenilaianJurulatihKetua extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ref_kategori_penilaian_jurulatih_id', 'aktif', 'created_by', 'updated_by'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
    ...
    {
        return [
            'ref_kategori_penilaian_jurulatih_id' => GeneralLabel::kategori_penilaian_jurulatih_ketua,
            'id' => GeneralLabel::id,
	...
	public function getRefKategoriPenilaianJurulatihKetua() {
        return $this->hasOne(RefKategoriPenilaianJurulatihKetua::className(), ['id' => 'ref_kategori_penilaian_jurulatih_id']);
    }
}
