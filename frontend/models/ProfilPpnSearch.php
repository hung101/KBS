...
/**
 * ProfilPpnSearch represents the model behind the search form about `app\models\ProfilPpn`.
 */
class ProfilPpnSearch extends ProfilPpn
{
    public $nama_peranan;
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'jabatan_id', 'auth_key', 'password_hash', 'password_reset_token', 'full_name', 'tel_mobile_no', 'tel_no', 'email', 
                'no_kad_pengenalan', 'nama_peranan', 'ipt_bendahari_e_biasiswa_desc', 'urusetia_kategori_program_e_bantuan_desc', 'urusetia_negeri_e_bantuan_desc',
                'ppn_negeri', 'ppn_sukan', 'aduan_jawatan'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['like', 'email', $this->email])
                ...
                ->andFilterWhere(['like', 'tbl_ref_negeri.desc', $this->ppn_negeri])
                ->andFilterWhere(['like', 'tbl_ref_sukan.desc', $this->ppn_sukan])
                ->andFilterWhere(['like', 'aduan_jawatan', $this->aduan_jawatan]);
