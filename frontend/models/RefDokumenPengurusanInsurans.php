...
/**
 * This is the model class for table "tbl_ref_dokumen_pengurusan_insurans".
 *
 * @property integer $id
 ...
 */
class RefDokumenPengurusanInsurans extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_dokumen_pengurusan_insurans';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['aktif', 'created_by', 'updated_by', 'parent_id'], 'integer', 'message' => GeneralMessage::yii_validation_integer],
