...
/**
 * PermohonanPenganjuranKosSearch represents the model behind the search form about `app\models\PermohonanPenganjuranKos`.
 */
class PermohonanPenganjuranKosSearch extends PermohonanPenganjuranKos
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['pengurusan_perhimpunan_kem_kos_id', 'permohonan_perganjuran_id'], 'integer'],
    ...
    {
        $query = PermohonanPenganjuranKos::find()
