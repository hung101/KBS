...
/**
 * RefInsentifPeringkatSearch represents the model behind the search form about `app\models\RefInsentifPeringkat`.
 */
class RefInsentifPeringkatSearch extends RefInsentifPeringkat
{
    /**
     * @inheritdoc
     */
