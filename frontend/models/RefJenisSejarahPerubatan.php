...
/**
 * This is the model class for table "tbl_ref_jenis_sejarah_perubatan".
 *
 * @property integer $id
 ...
 */
class RefJenisSejarahPerubatan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_jenis_sejarah_perubatan';
    }
