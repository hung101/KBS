...
/**
 * This is the model class for table "tbl_ref_bahagian_user".
 *
 * @property integer $id
 ...
 */
class RefBahagianUser extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ref_jabatan_user_id', 'aktif', 'created_by', 'updated_by'], 'integer'],
            [['desc'], 'required'],
