...
/**
 * TempahanKemudahanMsnSearch represents the model behind the search form about `app\models\TempahanKemudahanMsn`.
 */
class TempahanKemudahanMsnSearch extends TempahanKemudahanMsn
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['nama', 'no_kad_pengenalan', 'location_alamat_1', 'venue', 'tarikh_mula', 'catatan', 'tarikh_akhir', 'jenis_kadar', 'status', 'kategori_hakmilik', 
                'bayaran_sewa', 'nama_program'], 'safe'],
        ];
    }
    ...
    {
        $query = TempahanKemudahanMsn::find()
        ...
        $query->andFilterWhere(['like', 'nama', $this->nama])
            ...
            ->andFilterWhere(['like', 'tbl_pengurusan_kemudahan_venue_msn.nama_venue', $this->venue])
