...
/**
 * This is the model class for table "tbl_ref_kategori_penganjuran_sub".
 *
 * @property integer $id
 * @property integer $ref_kategori_penganjuran_id
 ...
 */
class RefKategoriPenganjuranSub extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_kategori_penganjuran_sub';
    }
