...
use app\models\PengurusanKemudahanAduanPemeriksa;

/**
 * PengurusanKemudahanAduanPemeriksaSearch represents the model behind the search form about `app\models\PengurusanKemudahanAduanPemeriksa`.
 */
class PengurusanKemudahanAduanPemeriksaSearch extends PengurusanKemudahanAduanPemeriksa
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['pengurusan_kemudahan_aduan_pemeriksa_id'], 'integer'],
    ...
    {
        $query = PengurusanKemudahanAduanPemeriksa::find()
        ...
        $query->andFilterWhere([
            'pengurusan_kemudahan_aduan_pemeriksa_id' => $this->pengurusan_kemudahan_aduan_pemeriksa_id,
