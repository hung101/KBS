...
class Peralatan extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['nama_peralatan','spesifikasi', 'kuantiti_unit','catatan', 'catatan_cadangan'], function ($attribute, $params) {
    ...
    public function attributeLabels()
    {
        return [
            ...
            'harga_per_unit_cadangan' => GeneralLabel::harga_per_unit,
            'harga_per_unit' => GeneralLabel::harga_per_unit,
            'jumlah_unit_cadangan' => GeneralLabel::jumlah_unit,
