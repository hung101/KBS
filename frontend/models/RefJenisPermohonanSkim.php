...
/**
 * This is the model class for table "tbl_ref_jenis_permohonan_skim".
 *
 * @property integer $id
 ...
 */
class RefJenisPermohonanSkim extends \yii\db\ActiveRecord
{
    
    const JUMLAH = 1;
    const MAKSIMUM = 2;
    const PERATUSA_DARIPADA_KOS_PERUBATAN = 3;
    ...
    {
        return 'tbl_ref_jenis_permohonan_skim';
    }
