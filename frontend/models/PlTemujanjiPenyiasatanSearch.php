...
/**
 * PlTemujanjiPenyiasatanSearch represents the model behind the search form about `app\models\PlTemujanjiPenyiasatan`.
 */
class PlTemujanjiPenyiasatanSearch extends PlTemujanjiPenyiasatan
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = PlTemujanjiPenyiasatan::find()
