...
/**
 * This is the model class for table "tbl_ref_sumber_kewangan_bantuan_penganjuran_kejohanan".
 *
 * @property integer $id
 ...
 */
class RefSumberKewanganBantuanPenganjuranKejohanan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'tbl_ref_sumber_kewangan_bantuan_penganjuran_kejohanan';
    }
